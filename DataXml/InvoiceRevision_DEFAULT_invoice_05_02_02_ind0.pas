...
unit InvoiceRevision_DEFAULT_invoice_05_02_02_ind0;
...
type
  ...
  TInvoiceInfo_AdditionalInfos = class;
  TInvoiceItemsTable = class;
  TInvoiceItemsTable_Item = class;
  TInvoiceItemsTable_Item_CustomsDeclarations = class;
  TInvoiceItemsTable_Item_AdditionalInfos = class;
  ...
  TInvoiceInfo_AdditionalInfosList = specialize GXMLSerializationObjectList<TInvoiceInfo_AdditionalInfos>;
  ...
  TInvoiceItemsTable_Item_CustomsDeclarationsList = specialize GXMLSerializationObjectList<TInvoiceItemsTable_Item_CustomsDeclarations>;
  TInvoiceItemsTable_Item_AdditionalInfosList = specialize GXMLSerializationObjectList<TInvoiceItemsTable_Item_AdditionalInfos>;
  ...
  private
    ...
    FAdditionalInfos:TInvoiceInfo_AdditionalInfos;
    FInvoiceDate:Tdate1;
  ...
  published
    ...
    property AdditionalInfos:TInvoiceInfo_AdditionalInfos read FAdditionalInfos;
  ...
  {  TInvoiceInfo_AdditionalInfos  }
  TInvoiceInfo_AdditionalInfos = class(TXmlSerializationObject)
  private
  ...
  private
    FCustomsDeclarations:TInvoiceItemsTable_Item_CustomsDeclarations;
    FAdditionalInfos:TInvoiceItemsTable_Item_AdditionalInfos;
  ...
  public
    destructor Destroy; override;
  published
    property CustomsDeclarations:TInvoiceItemsTable_Item_CustomsDeclarations read FCustomsDeclarations;
    property AdditionalInfos:TInvoiceItemsTable_Item_AdditionalInfos read FAdditionalInfos;
  ...
  {  TInvoiceItemsTable_Item_CustomsDeclarations  }
  TInvoiceItemsTable_Item_CustomsDeclarations = class(TXmlSerializationObject)
  private
  ...
  {  TInvoiceItemsTable_Item_AdditionalInfos  }
  TInvoiceItemsTable_Item_AdditionalInfos = class(TXmlSerializationObject)
  private
    FAdditionalInfo:TAdditionalInfoList;
  protected
    procedure InternalRegisterPropertys; override;
...
procedure TInvoiceInfo.SetInvoiceNumber(AValue: Tstring1000);
begin
...
procedure TInvoiceInfo.SetInvoiceRevisionNumber(AValue: Longint);
begin
...
begin
  ...
  FAdditionalInfos:=TInvoiceInfo_AdditionalInfos.Create;
end;
...
begin
  ...
  {  TInvoiceInfo_AdditionalInfos  }
procedure TInvoiceInfo_AdditionalInfos.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TInvoiceInfo_AdditionalInfos.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FAdditionalInfo:=TAdditionalInfoList.Create;
end;

destructor TInvoiceInfo_AdditionalInfos.Destroy;
begin
  ...
  {  TInvoiceItemsTable  }
procedure TInvoiceItemsTable.SetTotalWithVatExcluded(AValue: Double);
begin
  FTotalWithVatExcluded:=AValue;
  ModifiedProperty('TotalWithVatExcluded');
end;

procedure TInvoiceItemsTable.SetVat(AValue: Double);
begin
  FVat:=AValue;
  ModifiedProperty('Vat');
end;

procedure TInvoiceItemsTable.SetTotal(AValue: Double);
begin
  FTotal:=AValue;
...
procedure TInvoiceItemsTable_Item.SetQuantity(AValue: Double);
begin
  FQuantity:=AValue;
  ModifiedProperty('Quantity');
end;

procedure TInvoiceItemsTable_Item.SetPrice(AValue: Double);
begin
  FPrice:=AValue;
  ModifiedProperty('Price');
end;

procedure TInvoiceItemsTable_Item.SetExcise(AValue: Double);
begin
  FExcise:=AValue;
  ModifiedProperty('Excise');
end;

procedure TInvoiceItemsTable_Item.SetTaxRate(AValue: TTaxRateWithTwentyPercent);
begin
  FTaxRate:=AValue;
...
procedure TInvoiceItemsTable_Item.SetSubtotalWithVatExcluded(AValue: Double);
begin
  FSubtotalWithVatExcluded:=AValue;
  ModifiedProperty('SubtotalWithVatExcluded');
end;

procedure TInvoiceItemsTable_Item.SetVat(AValue: Double);
begin
  FVat:=AValue;
  ModifiedProperty('Vat');
end;

procedure TInvoiceItemsTable_Item.SetSubtotal(AValue: Double);
begin
  FSubtotal:=AValue;
...
begin
  inherited InternalInitChilds;
  FCustomsDeclarations:=TInvoiceItemsTable_Item_CustomsDeclarations.Create;
  FAdditionalInfos:=TInvoiceItemsTable_Item_AdditionalInfos.Create;
end;
...
begin
  ...
  {  TInvoiceItemsTable_Item_CustomsDeclarations  }
procedure TInvoiceItemsTable_Item_CustomsDeclarations.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TInvoiceItemsTable_Item_CustomsDeclarations.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FCustomsDeclaration:=TCustomsDeclarationList.Create;
end;

destructor TInvoiceItemsTable_Item_CustomsDeclarations.Destroy;
begin
  ...
  {  TInvoiceItemsTable_Item_AdditionalInfos  }
procedure TInvoiceItemsTable_Item_AdditionalInfos.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TInvoiceItemsTable_Item_AdditionalInfos.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FAdditionalInfo:=TAdditionalInfoList.Create;
end;

destructor TInvoiceItemsTable_Item_AdditionalInfos.Destroy;
begin
  FAdditionalInfo.Free;
  inherited Destroy;
end;
