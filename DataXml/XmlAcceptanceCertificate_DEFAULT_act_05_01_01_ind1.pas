...
unit XmlAcceptanceCertificate_DEFAULT_act_05_01_01_ind1;
...
type
  ...
  TAcceptanceCertificateBuyerTitle = class;
  ...
  TAcceptanceCertificateBuyerTitleList = specialize GXMLSerializationObjectList<TAcceptanceCertificateBuyerTitle>;
  ...
  {  TAcceptanceCertificateBuyerTitle  }
  TAcceptanceCertificateBuyerTitle = class(TXmlSerializationObject)
  private
    FSigner:TSignerInfo;
    FSignature:TAcceptanceCertificateSignatureInfo;
    FComplaints:Tstring2000;
    FAdditionalInfo:Tstring2000;
    procedure SetComplaints( AValue:Tstring2000);
  ...
  published
    ...
    //претензии
    property Complaints:Tstring2000 read FComplaints write SetComplaints;
...
implementation
  ...
  {  TAcceptanceCertificateBuyerTitle  }
procedure TAcceptanceCertificateBuyerTitle.SetComplaints(AValue: Tstring2000);
begin
  FComplaints:=AValue;
  CheckStrMinSize('Complaints', AValue);
  CheckStrMaxSize('Complaints', AValue);
  ModifiedProperty('Complaints');
end;

procedure TAcceptanceCertificateBuyerTitle.SetAdditionalInfo(AValue: Tstring2000);
begin
...
procedure TAcceptanceCertificateBuyerTitle.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  ...
  P:=RegisterProperty('Complaints', 'Complaints', [], '', 1, 2000);
  P:=RegisterProperty('AdditionalInfo', 'AdditionalInfo', [], '', 1, 2000);
end;

procedure TAcceptanceCertificateBuyerTitle.InternalInitChilds;
begin
...
destructor TAcceptanceCertificateBuyerTitle.Destroy;
begin
  FSigner.Free;
  FSignature.Free;
  inherited Destroy;
...
function TAcceptanceCertificateBuyerTitle.RootNodeName:string;
begin
  Result:='AcceptanceCertificateBuyerTitle';
end;
