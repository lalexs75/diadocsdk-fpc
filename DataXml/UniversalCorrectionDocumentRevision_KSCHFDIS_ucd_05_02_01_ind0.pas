...
unit UniversalCorrectionDocumentRevision_KSCHFDIS_ucd_05_02_01_ind0;
...
type
  ...
  private
    FOriginalValues:TCorrectableInvoiceItemFields_WithTwentyPercentAndTaxedByAgent;
    FCorrectedValues:TCorrectableInvoiceItemFields_WithTwentyPercentAndTaxedByAgent;
  ...
  published
    ...
    property OriginalValues:TCorrectableInvoiceItemFields_WithTwentyPercentAndTaxedByAgent read FOriginalValues;
    //значения после изменения
    property CorrectedValues:TCorrectableInvoiceItemFields_WithTwentyPercentAndTaxedByAgent read FCorrectedValues;
    //суммы к увеличению
...
begin
  inherited InternalInitChilds;
  FOriginalValues:=TCorrectableInvoiceItemFields_WithTwentyPercentAndTaxedByAgent.Create;
  FCorrectedValues:=TCorrectableInvoiceItemFields_WithTwentyPercentAndTaxedByAgent.Create;
