...
unit XmlTorg12_DEFAULT_tovtorg_05_01_04_ind1;
...
type
  ...
  TTovTorgBuyerTitleInfo = class;
  TTovTorgBuyerTitle = class;
  TTovTorgBuyerTitleInfo_Signers = class;
  ...
  TTovTorgBuyerTitleInfoList = specialize GXMLSerializationObjectList<TTovTorgBuyerTitleInfo>;
  TTovTorgBuyerTitleList = specialize GXMLSerializationObjectList<TTovTorgBuyerTitle>;
  TTovTorgBuyerTitleInfo_SignersList = specialize GXMLSerializationObjectList<TTovTorgBuyerTitleInfo_Signers>;
  ...
  TTovTorgBuyerTitleInfo = class(TXmlSerializationObject)
  private
    FEmployee:TEmployee;
    FOtherIssuer:TOtherIssuer;
    FAdditionalInfoId:TAdditionalInfoId;
    FSigners:TTovTorgBuyerTitleInfo_Signers;
  ...
  published
    ...
    property Signers:TTovTorgBuyerTitleInfo_Signers read FSigners;
  ...
  {  TTovTorgBuyerTitle  }
  TTovTorgBuyerTitle = class(TTovTorgBuyerTitleInfo)
  private
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  ...
  {  TTovTorgBuyerTitleInfo_Signers  }
  TTovTorgBuyerTitleInfo_Signers = class(TXmlSerializationObject)
  private
...
implementation
  ...
  {  TTovTorgBuyerTitleInfo  }
procedure TTovTorgBuyerTitleInfo.SetDocumentCreator(AValue: Tstring1000);
begin
...
procedure TTovTorgBuyerTitleInfo.SetDocumentCreatorBase(AValue: Tstring120);
begin
...
procedure TTovTorgBuyerTitleInfo.SetOperationCode(AValue: Tstring255);
begin
...
procedure TTovTorgBuyerTitleInfo.SetOperationContent(AValue: Tstring255);
begin
...
procedure TTovTorgBuyerTitleInfo.SetAcceptanceDate(AValue: Tdate1);
begin
...
procedure TTovTorgBuyerTitleInfo.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
...
begin
  ...
  {  TTovTorgBuyerTitle  }
procedure TTovTorgBuyerTitle.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TTovTorgBuyerTitle.InternalInitChilds;
begin
  inherited InternalInitChilds;
end;

destructor TTovTorgBuyerTitle.Destroy;
begin
  inherited Destroy;
end;

function TTovTorgBuyerTitle.RootNodeName:string;
begin
  Result:='TovTorgBuyerTitle';
end;

  {  TTovTorgBuyerTitleInfo_Signers  }
procedure TTovTorgBuyerTitleInfo_Signers.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TTovTorgBuyerTitleInfo_Signers.InternalInitChilds;
begin
  inherited InternalInitChilds;
...
destructor TTovTorgBuyerTitleInfo_Signers.Destroy;
begin
