...
unit UniversalCorrectionDocumentRevision_KSCHFDIS_ucd_05_01_02_ind1;
...
type
  ...
  private
    ...
    FSignerDetails:TExtendedSignerDetails_CorrectionBuyerTitle;
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  public
  ...
  published
    ...
    property SignerDetails:TExtendedSignerDetails_CorrectionBuyerTitle read FSignerDetails;
  end;
...
begin
  ...
  FSignerDetails:=TExtendedSignerDetails_CorrectionBuyerTitle.Create;
end;
