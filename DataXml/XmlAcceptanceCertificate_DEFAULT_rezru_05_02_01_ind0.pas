...
unit XmlAcceptanceCertificate_DEFAULT_rezru_05_02_01_ind0;
...
type
  ...
  TAcceptanceCertificate552SellerTitleInfo = class;
  TAcceptanceCertificate552SellerTitle = class;
  TAcceptanceCertificate552SellerTitleInfo_Signers = class;
  TAcceptanceCertificate552SellerTitleInfo_Grounds = class;
  TAcceptanceCertificate552SellerTitleInfo_Works = class;
  TAcceptanceCertificate552WorkDescription = class;
  TAcceptanceCertificate552WorkItem = class;
  TAcceptanceCertificate552TransferInfo = class;
  ...
  TAcceptanceCertificate552SellerTitleInfoList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552SellerTitleInfo>;
  TAcceptanceCertificate552SellerTitleList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552SellerTitle>;
  TAcceptanceCertificate552SellerTitleInfo_SignersList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552SellerTitleInfo_Signers>;
  TAcceptanceCertificate552SellerTitleInfo_GroundsList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552SellerTitleInfo_Grounds>;
  TAcceptanceCertificate552SellerTitleInfo_WorksList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552SellerTitleInfo_Works>;
  TAcceptanceCertificate552WorkDescriptionList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552WorkDescription>;
  TAcceptanceCertificate552WorkItemList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552WorkItem>;
  TAcceptanceCertificate552TransferInfoList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552TransferInfo>;
  ...
  TAcceptanceCertificate552SellerTitleInfo = class(TXmlSerializationObject)
  private
    FSeller:TExtendedOrganizationInfo;
    FBuyer:TExtendedOrganizationInfo;
    FSigners:TAcceptanceCertificate552SellerTitleInfo_Signers;
    FGrounds:TAcceptanceCertificate552SellerTitleInfo_Grounds;
    FWorks:TAcceptanceCertificate552SellerTitleInfo_Works;
    ...
    procedure SetRevisionNumber( AValue:TCommonRevisionNumber);
    ...
    procedure SetOperationTitle( AValue:Tstring2000);
  ...
  published
    ...
    property Signers:TAcceptanceCertificate552SellerTitleInfo_Signers read FSigners;
    property Grounds:TAcceptanceCertificate552SellerTitleInfo_Grounds read FGrounds;
    property Works:TAcceptanceCertificate552SellerTitleInfo_Works read FWorks;
    property AdditionalInfoId:TAdditionalInfoId read FAdditionalInfoId;
    property TransferInfo:TAcceptanceCertificate552TransferInfo read FTransferInfo;
    //Валюта (код) // КодОКВ
    property Currency:Tokv read FCurrency write SetCurrency;
    //Курс валюты // КурсВал/Файл/Документ/СвДокПРУ/ДенИзм/@КурсВал
    property CurrencyRate:Double read FCurrencyRate write SetCurrencyRate;
    //Дата составления документа о передаче товара // ДатаДокПРУ/Файл/Документ/СвДокПРУ/ИдентДок/@ДатаДокПРУ
    property DocumentDate:Tdate1 read FDocumentDate write SetDocumentDate;
    //Номер документа о передаче товара // НомДокПРУ/Файл/Документ/СвДокПРУ/ИдентДок/@НомДокПРУ
    property DocumentNumber:Tstring255 read FDocumentNumber write SetDocumentNumber;
    //Дата исправления документа // ДатаИспрДокПРУ/Файл/Документ/СвДокПРУ/ИспрДокПРУ/@ДатаИспрДокПРУ
    property RevisionDate:Tdate1 read FRevisionDate write SetRevisionDate;
    //Номер исправления документа // НомИспрДокПРУ/Файл/Документ/СвДокПРУ/ИспрДокПРУ/@НомИспрДокПРУ
    property RevisionNumber:TCommonRevisionNumber read FRevisionNumber write SetRevisionNumber;
    //Составитель файла информации продавца // НаимЭконСубСост/Файл/Документ/@НаимЭконСубСост
    property DocumentCreator:Tstring1000 read FDocumentCreator write SetDocumentCreator;
    //Основание, по которому экономический субъект является составителем файла // ОснДоверОргСост/Файл/Документ/@ОснДоверОргСост
    property DocumentCreatorBase:Tstring120 read FDocumentCreatorBase write SetDocumentCreatorBase;
    //Вид операции // ВидОперации/Файл/Документ/СвДокПРУ/СодФХЖ1/ВидОперации
    property OperationType:Tstring255 read FOperationType write SetOperationType;
    //Заголовок содержания операции // ЗагСодОпер/Файл/Документ/СвДокПРУ/СодФХЖ1/ЗагСодОпер
    property OperationTitle:Tstring2000 read FOperationTitle write SetOperationTitle;
    //Идентификатор государственного контракта // ИдГосКон/Файл/Документ/СвДокПРУ/СодФХЖ1/ИдГосКон
    property GovernmentContractInfo:Tstring255 read FGovernmentContractInfo write SetGovernmentContractInfo;
    //Наименование первичного документа, определенное организацией // НаимДокОпр/Файл/Документ/СвДокПРУ/НаимДок/@НаимДокОпр
    property DocumentName:Tstring255 read FDocumentName write SetDocumentName;
  end;

  {  TAcceptanceCertificate552SellerTitle  }
  TAcceptanceCertificate552SellerTitle = class(TAcceptanceCertificate552SellerTitleInfo)
  private
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  ...
  {  TAcceptanceCertificate552SellerTitleInfo_Signers  }
  TAcceptanceCertificate552SellerTitleInfo_Signers = class(TXmlSerializationObject)
  private
    FSignerReference:TSignerReference;
    FSignerDetails:TExtendedSignerDetails_551_552;
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  public
  ...
  published
    ...
    property SignerDetails:TExtendedSignerDetails_551_552 read FSignerDetails;
  end;

  {  TAcceptanceCertificate552SellerTitleInfo_Grounds  }
  TAcceptanceCertificate552SellerTitleInfo_Grounds = class(TXmlSerializationObject)
  private
    FGround:TGroundInfoList;
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  public
  ...
  published
    //Основание // Основание
    property Ground:TGroundInfoList read FGround;
  end;

  {  TAcceptanceCertificate552SellerTitleInfo_Works  }
  TAcceptanceCertificate552SellerTitleInfo_Works = class(TXmlSerializationObject)
  private
    FWork:TAcceptanceCertificate552WorkDescriptionList;
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  public
    destructor Destroy; override;
  published
    //Описание выполненных работ (услуг) // ОписРабот
    property Work:TAcceptanceCertificate552WorkDescriptionList read FWork;
  end;

  {  TAcceptanceCertificate552WorkDescription  }
  TAcceptanceCertificate552WorkDescription = class(TXmlSerializationObject)
  private
    FItem:TAcceptanceCertificate552WorkItemList;
    FStartingDate:Tdate1;
    FCompletionDate:Tdate1;
    FTotalWithVatExcluded:Double;
    FTotalVat:Double;
    FTotal:Double;
    procedure SetStartingDate( AValue:Tdate1);
    procedure SetCompletionDate( AValue:Tdate1);
    procedure SetTotalWithVatExcluded( AValue:Double);
    procedure SetTotalVat( AValue:Double);
  ...
  public
    destructor Destroy; override;
  published
    property Item:TAcceptanceCertificate552WorkItemList read FItem;
    //начало периода выполнения работ // НачРабот/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/@НачРабот
    property StartingDate:Tdate1 read FStartingDate write SetStartingDate;
    //окончание периода выполнения работ // КонРабот/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/@КонРабот
    property CompletionDate:Tdate1 read FCompletionDate write SetCompletionDate;
    //сумма без учета НДС - итого // СтБезНДСИт/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/@СтБезНДСИт
    property TotalWithVatExcluded:Double read FTotalWithVatExcluded write SetTotalWithVatExcluded;
    //сумма НДС - итого // СумНДСИт/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/@СумНДСИт
    property TotalVat:Double read FTotalVat write SetTotalVat;
    //сумма с учетом НДС - итого // СтУчНДСИт/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/@СтУчНДСИт
    property Total:Double read FTotal write SetTotal;
  end;

  {  TAcceptanceCertificate552WorkItem  }
  TAcceptanceCertificate552WorkItem = class(TXmlSerializationObject)
  private
    FAdditionalInfo:TAdditionalInfoList;
    FName:Tstring1000;
    FDescription:String;
    FUnitCode:Tokei;
    FUnitName:Tstring1000;
    FPrice:Double;
    FQuantity:Double;
    ...
    procedure SetName( AValue:Tstring1000);
    procedure SetDescription( AValue:String);
    procedure SetUnitCode( AValue:Tokei);
    procedure SetUnitName( AValue:Tstring1000);
  ...
  public
    destructor Destroy; override;
  published
    //Информационное поле описания работ // ИнфПолеОписРабот
    property AdditionalInfo:TAdditionalInfoList read FAdditionalInfo;
    //наименование // НаимРабот/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@НаимРабот
    property Name:Tstring1000 read FName write SetName;
    //описание работы // Описание/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/Описание
    property Description:String read FDescription write SetDescription;
    //код единицы измерения // ОКЕИ/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@ОКЕИ
    property UnitCode:Tokei read FUnitCode write SetUnitCode;
    //наименование единицы измерения // НаимЕдИзм/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@НаимЕдИзм
    property UnitName:Tstring1000 read FUnitName write SetUnitName;
    //цена // Цена/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@Цена
    property Price:Double read FPrice write SetPrice;
    //количество // Количество/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@Количество
    property Quantity:Double read FQuantity write SetQuantity;
    //сумма без учета НДС // СтоимБезНДС/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@СтоимБезНДС
    property SubtotalWithVatExcluded:Double read FSubtotalWithVatExcluded write SetSubtotalWithVatExcluded;
    //сумма НДС // СумНДС/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@СумНДС
    property Vat:Double read FVat write SetVat;
    //сумма с учетом НДС // СтоимУчНДС/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@СтоимУчНДС
    property Subtotal:Double read FSubtotal write SetSubtotal;
    //ставка налога // НалСт/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@НалСт
    property TaxRate:TTaxRateWithTwentyPercent read FTaxRate write SetTaxRate;
    //Корреспондирующие счета: дебет // КоррСчДебет/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@КоррСчДебет
    property ItemAccountDebit:String read FItemAccountDebit write SetItemAccountDebit;
    //Корреспондирующие счета: кредит // КоррСчКредит/Файл/Документ/СвДокПРУ/СодФХЖ1/ОписРабот/Работа/@КоррСчКредит
  ...
  TAcceptanceCertificate552TransferInfo = class(TXmlSerializationObject)
  private
    FAdditionalInfo:TAdditionalInfoList;
  ...
  published
    ...
    property AdditionalInfo:TAdditionalInfoList read FAdditionalInfo;
    //Содержание операции // СодОпер/Файл/Документ/СодФХЖ2/@СодОпер
    property OperationInfo:Tstring255 read FOperationInfo write SetOperationInfo;
    //Дата передачи результатов работ // ДатаПер/Файл/Документ/СодФХЖ2/@ДатаПер
    property TransferDate:Tdate1 read FTransferDate write SetTransferDate;
    //Дата передачи вещи, изготовленной по договору подряда // ДатаПерВещ/Файл/Документ/СодФХЖ2/СвПерВещи/@ДатаПерВещ
    property CreatedThingTransferDate:Tdate1 read FCreatedThingTransferDate write SetCreatedThingTransferDate;
    //Сведения о передаче // СвПерВещ/Файл/Документ/СодФХЖ2/СвПерВещи/@СвПерВещ
...
implementation
  ...
  {  TAcceptanceCertificate552SellerTitleInfo  }
procedure TAcceptanceCertificate552SellerTitleInfo.SetCurrency(AValue: Tokv);
begin
  FCurrency:=AValue;
...
procedure TAcceptanceCertificate552SellerTitleInfo.SetCurrencyRate(AValue: Double);
begin
  FCurrencyRate:=AValue;
  ModifiedProperty('CurrencyRate');
end;

procedure TAcceptanceCertificate552SellerTitleInfo.SetDocumentDate(AValue: Tdate1);
begin
...
procedure TAcceptanceCertificate552SellerTitleInfo.SetDocumentNumber(AValue: Tstring255);
begin
...
procedure TAcceptanceCertificate552SellerTitleInfo.SetRevisionDate(AValue: Tdate1);
begin
...
procedure TAcceptanceCertificate552SellerTitleInfo.SetRevisionNumber(AValue: TCommonRevisionNumber);
begin
  FRevisionNumber:=AValue;
  ModifiedProperty('RevisionNumber');
end;

procedure TAcceptanceCertificate552SellerTitleInfo.SetDocumentCreator(AValue: Tstring1000);
begin
...
procedure TAcceptanceCertificate552SellerTitleInfo.SetDocumentCreatorBase(AValue: Tstring120);
begin
...
procedure TAcceptanceCertificate552SellerTitleInfo.SetOperationType(AValue: Tstring255);
begin
...
procedure TAcceptanceCertificate552SellerTitleInfo.SetOperationTitle(AValue: Tstring2000);
begin
  FOperationTitle:=AValue;
  CheckStrMinSize('OperationTitle', AValue);
  CheckStrMaxSize('OperationTitle', AValue);
  ModifiedProperty('OperationTitle');
end;

procedure TAcceptanceCertificate552SellerTitleInfo.SetGovernmentContractInfo(AValue: Tstring255);
begin
...
procedure TAcceptanceCertificate552SellerTitleInfo.SetDocumentName(AValue: Tstring255);
begin
...
procedure TAcceptanceCertificate552SellerTitleInfo.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  ...
  P:=RegisterProperty('Grounds', 'Grounds', [], '', -1, -1);
  P:=RegisterProperty('Works', 'Works', [], '', -1, -1);
  ...
  P:=RegisterProperty('DocumentNumber', 'DocumentNumber', [], '', 1, 255);
  ...
  P:=RegisterProperty('OperationTitle', 'OperationTitle', [], '', 1, 2000);
...
procedure TAcceptanceCertificate552SellerTitleInfo.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FSeller:=TExtendedOrganizationInfo.Create;
  FBuyer:=TExtendedOrganizationInfo.Create;
  FSigners:=TAcceptanceCertificate552SellerTitleInfo_Signers.Create;
  FGrounds:=TAcceptanceCertificate552SellerTitleInfo_Grounds.Create;
  FWorks:=TAcceptanceCertificate552SellerTitleInfo_Works.Create;
...
begin
  ...
  {  TAcceptanceCertificate552SellerTitle  }
procedure TAcceptanceCertificate552SellerTitle.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TAcceptanceCertificate552SellerTitle.InternalInitChilds;
begin
  inherited InternalInitChilds;
end;

destructor TAcceptanceCertificate552SellerTitle.Destroy;
begin
  inherited Destroy;
end;

function TAcceptanceCertificate552SellerTitle.RootNodeName:string;
begin
  Result:='AcceptanceCertificate552SellerTitle';
end;

  {  TAcceptanceCertificate552SellerTitleInfo_Signers  }
procedure TAcceptanceCertificate552SellerTitleInfo_Signers.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TAcceptanceCertificate552SellerTitleInfo_Signers.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FSignerReference:=TSignerReference.Create;
  FSignerDetails:=TExtendedSignerDetails_551_552.Create;
end;

destructor TAcceptanceCertificate552SellerTitleInfo_Signers.Destroy;
begin
  ...
  {  TAcceptanceCertificate552SellerTitleInfo_Grounds  }
procedure TAcceptanceCertificate552SellerTitleInfo_Grounds.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  P:=RegisterProperty('Ground', 'Ground', [], '', -1, -1);
end;

procedure TAcceptanceCertificate552SellerTitleInfo_Grounds.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FGround:=TGroundInfoList.Create;
end;

destructor TAcceptanceCertificate552SellerTitleInfo_Grounds.Destroy;
begin
  FGround.Free;
  inherited Destroy;
end;
  ...
  {  TAcceptanceCertificate552SellerTitleInfo_Works  }
procedure TAcceptanceCertificate552SellerTitleInfo_Works.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  P:=RegisterProperty('Work', 'Work', [], '', -1, -1);
end;

procedure TAcceptanceCertificate552SellerTitleInfo_Works.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FWork:=TAcceptanceCertificate552WorkDescriptionList.Create;
end;

destructor TAcceptanceCertificate552SellerTitleInfo_Works.Destroy;
begin
  FWork.Free;
  inherited Destroy;
end;
  ...
  {  TAcceptanceCertificate552WorkDescription  }
procedure TAcceptanceCertificate552WorkDescription.SetStartingDate(AValue: Tdate1);
begin
  FStartingDate:=AValue;
  CheckStrMinSize('StartingDate', AValue);
  CheckStrMaxSize('StartingDate', AValue);
  ModifiedProperty('StartingDate');
end;

procedure TAcceptanceCertificate552WorkDescription.SetCompletionDate(AValue: Tdate1);
begin
  FCompletionDate:=AValue;
  CheckStrMinSize('CompletionDate', AValue);
  CheckStrMaxSize('CompletionDate', AValue);
  ModifiedProperty('CompletionDate');
end;

procedure TAcceptanceCertificate552WorkDescription.SetTotalWithVatExcluded(AValue: Double);
begin
  FTotalWithVatExcluded:=AValue;
  ModifiedProperty('TotalWithVatExcluded');
end;

procedure TAcceptanceCertificate552WorkDescription.SetTotalVat(AValue: Double);
begin
  FTotalVat:=AValue;
  ModifiedProperty('TotalVat');
end;

procedure TAcceptanceCertificate552WorkDescription.SetTotal(AValue: Double);
begin
  FTotal:=AValue;
  ModifiedProperty('Total');
end;

procedure TAcceptanceCertificate552WorkDescription.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  P:=RegisterProperty('Item', 'Item', [], '', -1, -1);
  P:=RegisterProperty('StartingDate', 'StartingDate', [], '', 10, 10);
  P:=RegisterProperty('CompletionDate', 'CompletionDate', [], '', 10, 10);
  P:=RegisterProperty('TotalWithVatExcluded', 'TotalWithVatExcluded', [], '', -1, -1);
    P.TotalDigits := 19;
    P.FractionDigits := 2;
  P:=RegisterProperty('TotalVat', 'TotalVat', [], '', -1, -1);
    P.TotalDigits := 19;
    P.FractionDigits := 2;
...
procedure TAcceptanceCertificate552WorkDescription.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FItem:=TAcceptanceCertificate552WorkItemList.Create;
end;
...
begin
  ...
  {  TAcceptanceCertificate552WorkItem  }
procedure TAcceptanceCertificate552WorkItem.SetName(AValue: Tstring1000);
begin
  FName:=AValue;
...
procedure TAcceptanceCertificate552WorkItem.SetDescription(AValue: String);
begin
  FDescription:=AValue;
  CheckStrMinSize('Description', AValue);
  CheckStrMaxSize('Description', AValue);
  ModifiedProperty('Description');
end;

procedure TAcceptanceCertificate552WorkItem.SetUnitCode(AValue: Tokei);
begin
  FUnitCode:=AValue;
  CheckStrMinSize('UnitCode', AValue);
  CheckStrMaxSize('UnitCode', AValue);
  ModifiedProperty('UnitCode');
end;

procedure TAcceptanceCertificate552WorkItem.SetUnitName(AValue: Tstring1000);
begin
  FUnitName:=AValue;
...
procedure TAcceptanceCertificate552WorkItem.SetPrice(AValue: Double);
begin
  FPrice:=AValue;
  ModifiedProperty('Price');
end;

procedure TAcceptanceCertificate552WorkItem.SetQuantity(AValue: Double);
begin
  FQuantity:=AValue;
  ModifiedProperty('Quantity');
end;

procedure TAcceptanceCertificate552WorkItem.SetSubtotalWithVatExcluded(AValue: Double);
begin
  FSubtotalWithVatExcluded:=AValue;
  ModifiedProperty('SubtotalWithVatExcluded');
end;

procedure TAcceptanceCertificate552WorkItem.SetVat(AValue: Double);
begin
  FVat:=AValue;
  ModifiedProperty('Vat');
end;

procedure TAcceptanceCertificate552WorkItem.SetSubtotal(AValue: Double);
begin
  FSubtotal:=AValue;
  ModifiedProperty('Subtotal');
end;

procedure TAcceptanceCertificate552WorkItem.SetTaxRate(AValue: TTaxRateWithTwentyPercent);
begin
  FTaxRate:=AValue;
...
procedure TAcceptanceCertificate552WorkItem.SetItemAccountDebit(AValue: String);
begin
...
procedure TAcceptanceCertificate552WorkItem.SetItemAccountCredit(AValue: String);
begin
...
procedure TAcceptanceCertificate552WorkItem.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  P:=RegisterProperty('AdditionalInfo', 'AdditionalInfo', [], '', -1, -1);
  P:=RegisterProperty('Name', 'Name', [], '', 1, 1000);
  P:=RegisterProperty('Description', 'Description', [], '', 1, 10000);
  P:=RegisterProperty('UnitCode', 'UnitCode', [], '', 3, 4);
  P:=RegisterProperty('UnitName', 'UnitName', [], '', 1, 1000);
...
procedure TAcceptanceCertificate552WorkItem.InternalInitChilds;
begin
  inherited InternalInitChilds;
...
begin
  ...
  {  TAcceptanceCertificate552TransferInfo  }
procedure TAcceptanceCertificate552TransferInfo.SetOperationInfo(AValue: Tstring255);
begin
...
procedure TAcceptanceCertificate552TransferInfo.SetTransferDate(AValue: Tdate1);
begin
...
procedure TAcceptanceCertificate552TransferInfo.SetCreatedThingTransferDate(AValue: Tdate1);
begin
...
procedure TAcceptanceCertificate552TransferInfo.SetCreatedThingInfo(AValue: Tstring1000);
begin
...
procedure TAcceptanceCertificate552TransferInfo.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TAcceptanceCertificate552TransferInfo.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FAdditionalInfo:=TAdditionalInfoList.Create;
end;
