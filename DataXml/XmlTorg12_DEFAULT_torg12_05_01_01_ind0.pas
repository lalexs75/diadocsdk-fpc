...
unit XmlTorg12_DEFAULT_torg12_05_01_01_ind0;
...
type
  ...
  TTorg12SellerTitle = class;
  TTorg12SellerTitle_Grounds = class;
  TTorg12Table = class;
  TTorg12Table_Item = class;
  ...
  TTorg12SellerTitleList = specialize GXMLSerializationObjectList<TTorg12SellerTitle>;
  TTorg12SellerTitle_GroundsList = specialize GXMLSerializationObjectList<TTorg12SellerTitle_Grounds>;
  TTorg12TableList = specialize GXMLSerializationObjectList<TTorg12Table>;
  TTorg12Table_ItemList = specialize GXMLSerializationObjectList<TTorg12Table_Item>;
  ...
  {  TTorg12SellerTitle  }
  TTorg12SellerTitle = class(TXmlSerializationObject)
  private
    FSeller:TDocflowParticipant;
    FBuyer:TDocflowParticipant;
    FShipper:TOrganizationDetails_WithAddressOptional;
    FConsignee:TOrganizationDetails;
    FSupplier:TOrganizationDetails;
    FPayer:TOrganizationDetails;
    FGrounds:TTorg12SellerTitle_Grounds;
    FTable:TTorg12Table;
    ...
    FWaybillDate:Tdate1;
    FWaybillNumber:Tstring256;
    FOperationCode:Tstring255;
    FTotal:Double;
    FTotalInWords:Tstring255;
    FSupplyDate:Tdate1;
    FAdditionalInfo:Tstring2000z;
    FAttachmentSheetsQuantity:Tinteger10;
    procedure SetDocumentDate( AValue:Tdate1);
    procedure SetDocumentNumber( AValue:Tstring255);
    procedure SetWaybillDate( AValue:Tdate1);
    procedure SetWaybillNumber( AValue:Tstring256);
    procedure SetOperationCode( AValue:Tstring255);
    procedure SetTotal( AValue:Double);
    procedure SetTotalInWords( AValue:Tstring255);
    procedure SetSupplyDate( AValue:Tdate1);
    procedure SetAdditionalInfo( AValue:Tstring2000z);
    procedure SetAttachmentSheetsQuantity( AValue:Tinteger10);
  protected
  ...
  published
    ...
    property Seller:TDocflowParticipant read FSeller;
    //Участник документооборота, которому отпущен товар
    property Buyer:TDocflowParticipant read FBuyer;
    //Грузоотправитель
    property Shipper:TOrganizationDetails_WithAddressOptional read FShipper;
    //Грузополучатель
    property Consignee:TOrganizationDetails read FConsignee;
    //Поставщик
    property Supplier:TOrganizationDetails read FSupplier;
    //Плательщик
    property Payer:TOrganizationDetails read FPayer;
    property Grounds:TTorg12SellerTitle_Grounds read FGrounds;
    property Table:TTorg12Table read FTable;
    //Отпуск разрешил
    property SupplyAllowedBy:TOfficial read FSupplyAllowedBy;
    //Отпуск произвел
    property SupplyPerformedBy:TOfficial read FSupplyPerformedBy;
    //Главный бухгалтер
    property ChiefAccountant:TOfficial read FChiefAccountant;
    //Подписант
    ...
    property WaybillDate:Tdate1 read FWaybillDate write SetWaybillDate;
    //Номер транспортной накладной
    property WaybillNumber:Tstring256 read FWaybillNumber write SetWaybillNumber;
    //Код вида операции
    ...
    property TotalInWords:Tstring255 read FTotalInWords write SetTotalInWords;
    //Дата отпуска
    property SupplyDate:Tdate1 read FSupplyDate write SetSupplyDate;
    //Дополнительные сведения
    property AdditionalInfo:Tstring2000z read FAdditionalInfo write SetAdditionalInfo;
    //Приложение, количество листов
    property AttachmentSheetsQuantity:Tinteger10 read FAttachmentSheetsQuantity write SetAttachmentSheetsQuantity;
  end;

  {  TTorg12SellerTitle_Grounds  }
  TTorg12SellerTitle_Grounds = class(TXmlSerializationObject)
  private
  ...
  TTorg12Table = class(TXmlSerializationObject)
  private
    FItem:TTorg12Table_ItemList;
    FParcelsQuantityTotal:Tinteger10;
    FParcelsQuantityTotalInWords:Tstring255;
    FGrossQuantityTotal:Double;
    FGrossQuantityTotalInWords:Tstring255;
    FNetQuantityTotal:Double;
    FNetQuantityTotalInWords:Tstring255;
    FQuantityTotal:Double;
    FTotalWithVatExcluded:Double;
    FVat:Double;
    procedure SetParcelsQuantityTotal( AValue:Tinteger10);
    procedure SetParcelsQuantityTotalInWords( AValue:Tstring255);
    procedure SetGrossQuantityTotal( AValue:Double);
    procedure SetGrossQuantityTotalInWords( AValue:Tstring255);
    procedure SetNetQuantityTotal( AValue:Double);
    procedure SetNetQuantityTotalInWords( AValue:Tstring255);
    procedure SetQuantityTotal( AValue:Double);
  ...
  public
    destructor Destroy; override;
  published
    property Item:TTorg12Table_ItemList read FItem;
    //Количество мест, штук - всего по накладной
    property ParcelsQuantityTotal:Tinteger10 read FParcelsQuantityTotal write SetParcelsQuantityTotal;
    //Количество мест, штук - всего по накладной, прописью
    property ParcelsQuantityTotalInWords:Tstring255 read FParcelsQuantityTotalInWords write SetParcelsQuantityTotalInWords;
    //Брутто - всего по накладной
    property GrossQuantityTotal:Double read FGrossQuantityTotal write SetGrossQuantityTotal;
    //Брутто - всего по накладной, прописью
    property GrossQuantityTotalInWords:Tstring255 read FGrossQuantityTotalInWords write SetGrossQuantityTotalInWords;
    //Нетто - всего по накладной
    property NetQuantityTotal:Double read FNetQuantityTotal write SetNetQuantityTotal;
    //Нетто - всего по накладной, прописью
    property NetQuantityTotalInWords:Tstring255 read FNetQuantityTotalInWords write SetNetQuantityTotalInWords;
    //Количество (масса нетто) - всего по накладной
    property QuantityTotal:Double read FQuantityTotal write SetQuantityTotal;
  ...
  {  TTorg12Table_Item  }
  TTorg12Table_Item = class(TXmlSerializationObject)
  private
    FName:Tstring1000;
    FFeature:Tstring1000;
    FSort:Tstring10;
    FNomenclatureArticle:Tstring50;
    FCode:Tstring100;
    FUnitCode:Tokei;
    FUnitName:Tstring1000;
    FParcelType:Tstring1000;
    FParcelCapacity:Tinteger10;
    FParcelsQuantity:Tinteger12;
    FGrossQuantity:Double;
    FQuantity:Double;
    FPrice:Double;
    FTaxRate:Double;
    ...
    procedure SetFeature( AValue:Tstring1000);
    procedure SetSort( AValue:Tstring10);
    procedure SetNomenclatureArticle( AValue:Tstring50);
    procedure SetCode( AValue:Tstring100);
    procedure SetUnitCode( AValue:Tokei);
    procedure SetUnitName( AValue:Tstring1000);
    procedure SetParcelType( AValue:Tstring1000);
    procedure SetParcelCapacity( AValue:Tinteger10);
    procedure SetParcelsQuantity( AValue:Tinteger12);
    procedure SetGrossQuantity( AValue:Double);
    procedure SetQuantity( AValue:Double);
    procedure SetPrice( AValue:Double);
    procedure SetTaxRate( AValue:Double);
  ...
  published
    ...
    //Характеристика
    property Feature:Tstring1000 read FFeature write SetFeature;
    //Сорт товара
    property Sort:Tstring10 read FSort write SetSort;
    //Артикул
    property NomenclatureArticle:Tstring50 read FNomenclatureArticle write SetNomenclatureArticle;
    //Код товара
    property Code:Tstring100 read FCode write SetCode;
    ...
    //Вид упаковки
    property ParcelType:Tstring1000 read FParcelType write SetParcelType;
    //Количество в одном месте
    property ParcelCapacity:Tinteger10 read FParcelCapacity write SetParcelCapacity;
    //Количество мест
    property ParcelsQuantity:Tinteger12 read FParcelsQuantity write SetParcelsQuantity;
    //Брутто
    property GrossQuantity:Double read FGrossQuantity write SetGrossQuantity;
  ...
  published
    ...
    property Inn:Tstring20 read FInn write SetInn;
    property Kpp:Tstring20 read FKpp write SetKpp;
    //Признак того, что Организация - это ИП
...
implementation
  ...
  {  TTorg12SellerTitle  }
procedure TTorg12SellerTitle.SetDocumentDate(AValue: Tdate1);
begin
...
procedure TTorg12SellerTitle.SetDocumentNumber(AValue: Tstring255);
begin
...
procedure TTorg12SellerTitle.SetWaybillDate(AValue: Tdate1);
begin
  FWaybillDate:=AValue;
  CheckStrMinSize('WaybillDate', AValue);
  CheckStrMaxSize('WaybillDate', AValue);
  ModifiedProperty('WaybillDate');
end;

procedure TTorg12SellerTitle.SetWaybillNumber(AValue: Tstring256);
begin
  FWaybillNumber:=AValue;
  CheckStrMinSize('WaybillNumber', AValue);
  CheckStrMaxSize('WaybillNumber', AValue);
  ModifiedProperty('WaybillNumber');
end;

procedure TTorg12SellerTitle.SetOperationCode(AValue: Tstring255);
begin
...
procedure TTorg12SellerTitle.SetTotal(AValue: Double);
begin
  FTotal:=AValue;
  ModifiedProperty('Total');
end;

procedure TTorg12SellerTitle.SetTotalInWords(AValue: Tstring255);
begin
  FTotalInWords:=AValue;
  CheckStrMinSize('TotalInWords', AValue);
  CheckStrMaxSize('TotalInWords', AValue);
  ModifiedProperty('TotalInWords');
end;

procedure TTorg12SellerTitle.SetSupplyDate(AValue: Tdate1);
begin
  FSupplyDate:=AValue;
  CheckStrMinSize('SupplyDate', AValue);
  CheckStrMaxSize('SupplyDate', AValue);
  ModifiedProperty('SupplyDate');
end;

procedure TTorg12SellerTitle.SetAdditionalInfo(AValue: Tstring2000z);
begin
...
procedure TTorg12SellerTitle.SetAttachmentSheetsQuantity(AValue: Tinteger10);
begin
  FAttachmentSheetsQuantity:=AValue;
  ModifiedProperty('AttachmentSheetsQuantity');
end;

procedure TTorg12SellerTitle.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  ...
  P:=RegisterProperty('Supplier', 'Supplier', [], '', -1, -1);
  P:=RegisterProperty('Payer', 'Payer', [], '', -1, -1);
  P:=RegisterProperty('Grounds', 'Grounds', [], '', -1, -1);
  P:=RegisterProperty('Table', 'Table', [], '', -1, -1);
  P:=RegisterProperty('SupplyAllowedBy', 'SupplyAllowedBy', [], '', -1, -1);
  P:=RegisterProperty('SupplyPerformedBy', 'SupplyPerformedBy', [], '', -1, -1);
  P:=RegisterProperty('ChiefAccountant', 'ChiefAccountant', [], '', -1, -1);
  ...
  P:=RegisterProperty('WaybillDate', 'WaybillDate', [], '', 10, 10);
  P:=RegisterProperty('WaybillNumber', 'WaybillNumber', [], '', 1, 256);
  P:=RegisterProperty('OperationCode', 'OperationCode', [], '', 1, 255);
  P:=RegisterProperty('Total', 'Total', [xsaRequared], '', -1, -1);
    P.TotalDigits := 17;
    P.FractionDigits := 2;
  P:=RegisterProperty('TotalInWords', 'TotalInWords', [], '', 1, 255);
  P:=RegisterProperty('SupplyDate', 'SupplyDate', [], '', 10, 10);
  P:=RegisterProperty('AdditionalInfo', 'AdditionalInfo', [], '', 0, 2000);
  P:=RegisterProperty('AttachmentSheetsQuantity', 'AttachmentSheetsQuantity', [], '', -1, -1);
    P.TotalDigits := 10;
    P.FractionDigits := 0;
end;

procedure TTorg12SellerTitle.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FSeller:=TDocflowParticipant.Create;
  FBuyer:=TDocflowParticipant.Create;
  FShipper:=TOrganizationDetails_WithAddressOptional.Create;
  FConsignee:=TOrganizationDetails.Create;
  FSupplier:=TOrganizationDetails.Create;
  FPayer:=TOrganizationDetails.Create;
  FGrounds:=TTorg12SellerTitle_Grounds.Create;
  FTable:=TTorg12Table.Create;
...
destructor TTorg12SellerTitle.Destroy;
begin
  FSeller.Free;
  FBuyer.Free;
  FShipper.Free;
  ...
  FGrounds.Free;
  FTable.Free;
  FSupplyAllowedBy.Free;
  FSupplyPerformedBy.Free;
  FChiefAccountant.Free;
  FSigner.Free;
  inherited Destroy;
end;

function TTorg12SellerTitle.RootNodeName:string;
begin
  Result:='Torg12SellerTitle';
end;

  {  TTorg12SellerTitle_Grounds  }
procedure TTorg12SellerTitle_Grounds.SetDocumentName(AValue: Tstring255);
begin
...
procedure TTorg12SellerTitle_Grounds.SetDocumentNumber(AValue: Tstring256);
begin
  FDocumentNumber:=AValue;
  CheckStrMinSize('DocumentNumber', AValue);
  CheckStrMaxSize('DocumentNumber', AValue);
...
procedure TTorg12SellerTitle_Grounds.SetDocumentDate(AValue: Tdate1);
begin
  FDocumentDate:=AValue;
  CheckStrMinSize('DocumentDate', AValue);
  CheckStrMaxSize('DocumentDate', AValue);
...
procedure TTorg12SellerTitle_Grounds.SetAdditionalInfo(AValue: Tstring1000z);
begin
  FAdditionalInfo:=AValue;
  CheckStrMinSize('AdditionalInfo', AValue);
  CheckStrMaxSize('AdditionalInfo', AValue);
...
procedure TTorg12SellerTitle_Grounds.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  ...
  P:=RegisterProperty('DocumentDate', 'DocumentDate', [], '', 10, 10);
  P:=RegisterProperty('AdditionalInfo', 'AdditionalInfo', [], '', 0, 1000);
end;

procedure TTorg12SellerTitle_Grounds.InternalInitChilds;
begin
  inherited InternalInitChilds;
end;

destructor TTorg12SellerTitle_Grounds.Destroy;
begin
  inherited Destroy;
end;

  {  TTorg12Table  }
procedure TTorg12Table.SetParcelsQuantityTotal(AValue: Tinteger10);
begin
  FParcelsQuantityTotal:=AValue;
  ModifiedProperty('ParcelsQuantityTotal');
end;

procedure TTorg12Table.SetParcelsQuantityTotalInWords(AValue: Tstring255);
begin
  FParcelsQuantityTotalInWords:=AValue;
  CheckStrMinSize('ParcelsQuantityTotalInWords', AValue);
  CheckStrMaxSize('ParcelsQuantityTotalInWords', AValue);
  ModifiedProperty('ParcelsQuantityTotalInWords');
end;

procedure TTorg12Table.SetGrossQuantityTotal(AValue: Double);
begin
  FGrossQuantityTotal:=AValue;
  ModifiedProperty('GrossQuantityTotal');
end;

procedure TTorg12Table.SetGrossQuantityTotalInWords(AValue: Tstring255);
begin
  FGrossQuantityTotalInWords:=AValue;
  CheckStrMinSize('GrossQuantityTotalInWords', AValue);
  CheckStrMaxSize('GrossQuantityTotalInWords', AValue);
  ModifiedProperty('GrossQuantityTotalInWords');
end;

procedure TTorg12Table.SetNetQuantityTotal(AValue: Double);
begin
  FNetQuantityTotal:=AValue;
  ModifiedProperty('NetQuantityTotal');
end;

procedure TTorg12Table.SetNetQuantityTotalInWords(AValue: Tstring255);
begin
  FNetQuantityTotalInWords:=AValue;
  CheckStrMinSize('NetQuantityTotalInWords', AValue);
  CheckStrMaxSize('NetQuantityTotalInWords', AValue);
  ModifiedProperty('NetQuantityTotalInWords');
end;

procedure TTorg12Table.SetQuantityTotal(AValue: Double);
begin
  FQuantityTotal:=AValue;
  ModifiedProperty('QuantityTotal');
end;

procedure TTorg12Table.SetTotalWithVatExcluded(AValue: Double);
begin
  FTotalWithVatExcluded:=AValue;
  ModifiedProperty('TotalWithVatExcluded');
end;

procedure TTorg12Table.SetVat(AValue: Double);
begin
  FVat:=AValue;
  ModifiedProperty('Vat');
end;

procedure TTorg12Table.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  P:=RegisterProperty('Item', 'Item', [], '', -1, -1);
  P:=RegisterProperty('ParcelsQuantityTotal', 'ParcelsQuantityTotal', [], '', -1, -1);
    P.TotalDigits := 10;
    P.FractionDigits := 0;
  P:=RegisterProperty('ParcelsQuantityTotalInWords', 'ParcelsQuantityTotalInWords', [], '', 1, 255);
  P:=RegisterProperty('GrossQuantityTotal', 'GrossQuantityTotal', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 3;
  P:=RegisterProperty('GrossQuantityTotalInWords', 'GrossQuantityTotalInWords', [], '', 1, 255);
  P:=RegisterProperty('NetQuantityTotal', 'NetQuantityTotal', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 3;
  P:=RegisterProperty('NetQuantityTotalInWords', 'NetQuantityTotalInWords', [], '', 1, 255);
  P:=RegisterProperty('QuantityTotal', 'QuantityTotal', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 3;
...
procedure TTorg12Table.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FItem:=TTorg12Table_ItemList.Create;
end;

destructor TTorg12Table.Destroy;
begin
  FItem.Free;
  inherited Destroy;
end;
  ...
  {  TTorg12Table_Item  }
procedure TTorg12Table_Item.SetName(AValue: Tstring1000);
begin
  FName:=AValue;
...
procedure TTorg12Table_Item.SetFeature(AValue: Tstring1000);
begin
  FFeature:=AValue;
  CheckStrMinSize('Feature', AValue);
  CheckStrMaxSize('Feature', AValue);
  ModifiedProperty('Feature');
end;

procedure TTorg12Table_Item.SetSort(AValue: Tstring10);
begin
  FSort:=AValue;
  CheckStrMinSize('Sort', AValue);
  CheckStrMaxSize('Sort', AValue);
  ModifiedProperty('Sort');
end;

procedure TTorg12Table_Item.SetNomenclatureArticle(AValue: Tstring50);
begin
  FNomenclatureArticle:=AValue;
  CheckStrMinSize('NomenclatureArticle', AValue);
  CheckStrMaxSize('NomenclatureArticle', AValue);
  ModifiedProperty('NomenclatureArticle');
end;

procedure TTorg12Table_Item.SetCode(AValue: Tstring100);
begin
  FCode:=AValue;
...
procedure TTorg12Table_Item.SetUnitCode(AValue: Tokei);
begin
  FUnitCode:=AValue;
...
procedure TTorg12Table_Item.SetUnitName(AValue: Tstring1000);
begin
  FUnitName:=AValue;
...
procedure TTorg12Table_Item.SetParcelType(AValue: Tstring1000);
begin
  FParcelType:=AValue;
  CheckStrMinSize('ParcelType', AValue);
  CheckStrMaxSize('ParcelType', AValue);
  ModifiedProperty('ParcelType');
end;

procedure TTorg12Table_Item.SetParcelCapacity(AValue: Tinteger10);
begin
  FParcelCapacity:=AValue;
  ModifiedProperty('ParcelCapacity');
end;

procedure TTorg12Table_Item.SetParcelsQuantity(AValue: Tinteger12);
begin
  FParcelsQuantity:=AValue;
  ModifiedProperty('ParcelsQuantity');
end;

procedure TTorg12Table_Item.SetGrossQuantity(AValue: Double);
begin
  FGrossQuantity:=AValue;
  ModifiedProperty('GrossQuantity');
end;

procedure TTorg12Table_Item.SetQuantity(AValue: Double);
begin
  FQuantity:=AValue;
  ModifiedProperty('Quantity');
end;

procedure TTorg12Table_Item.SetPrice(AValue: Double);
begin
  FPrice:=AValue;
  ModifiedProperty('Price');
end;

procedure TTorg12Table_Item.SetTaxRate(AValue: Double);
begin
  FTaxRate:=AValue;
  ModifiedProperty('TaxRate');
end;

procedure TTorg12Table_Item.SetSubtotalWithVatExcluded(AValue: Double);
begin
  FSubtotalWithVatExcluded:=AValue;
  ModifiedProperty('SubtotalWithVatExcluded');
end;

procedure TTorg12Table_Item.SetVat(AValue: Double);
begin
  FVat:=AValue;
  ModifiedProperty('Vat');
end;

procedure TTorg12Table_Item.SetSubtotal(AValue: Double);
begin
  FSubtotal:=AValue;
  ModifiedProperty('Subtotal');
end;

procedure TTorg12Table_Item.SetAdditionalInfo(AValue: Tstring1000z);
begin
  FAdditionalInfo:=AValue;
  CheckStrMinSize('AdditionalInfo', AValue);
  CheckStrMaxSize('AdditionalInfo', AValue);
...
procedure TTorg12Table_Item.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  P:=RegisterProperty('Name', 'Name', [], '', 1, 1000);
  P:=RegisterProperty('Feature', 'Feature', [], '', 1, 1000);
  P:=RegisterProperty('Sort', 'Sort', [], '', 1, 10);
  P:=RegisterProperty('NomenclatureArticle', 'NomenclatureArticle', [], '', 1, 50);
  P:=RegisterProperty('Code', 'Code', [], '', 1, 100);
  P:=RegisterProperty('UnitCode', 'UnitCode', [], '', 3, 4);
  P:=RegisterProperty('UnitName', 'UnitName', [], '', 1, 1000);
  P:=RegisterProperty('ParcelType', 'ParcelType', [], '', 1, 1000);
  P:=RegisterProperty('ParcelCapacity', 'ParcelCapacity', [], '', -1, -1);
    P.TotalDigits := 10;
    P.FractionDigits := 0;
  P:=RegisterProperty('ParcelsQuantity', 'ParcelsQuantity', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 0;
  P:=RegisterProperty('GrossQuantity', 'GrossQuantity', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 3;
...
procedure TTorg12Table_Item.InternalInitChilds;
begin
  inherited InternalInitChilds;
end;

destructor TTorg12Table_Item.Destroy;
begin
  inherited Destroy;
end;
