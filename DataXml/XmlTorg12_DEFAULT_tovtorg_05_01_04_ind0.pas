...
unit XmlTorg12_DEFAULT_tovtorg_05_01_04_ind0;
...
type
  ...
  TTovTorgSellerTitleInfo = class;
  TTovTorgSellerTitle = class;
  TTovTorgSellerTitleInfo_Signers = class;
  TTovTorgSellerTitleInfo_Grounds = class;
  TTovTorgTable = class;
  TTovTorgItem = class;
  TTovTorgTransferInfo = class;
  TTovTorgTransferInfo_AdditionalInfos = class;
  ...
  TTovTorgSellerTitleInfoList = specialize GXMLSerializationObjectList<TTovTorgSellerTitleInfo>;
  TTovTorgSellerTitleList = specialize GXMLSerializationObjectList<TTovTorgSellerTitle>;
  TTovTorgSellerTitleInfo_SignersList = specialize GXMLSerializationObjectList<TTovTorgSellerTitleInfo_Signers>;
  TTovTorgSellerTitleInfo_GroundsList = specialize GXMLSerializationObjectList<TTovTorgSellerTitleInfo_Grounds>;
  TTovTorgTableList = specialize GXMLSerializationObjectList<TTovTorgTable>;
  TTovTorgItemList = specialize GXMLSerializationObjectList<TTovTorgItem>;
  TTovTorgTransferInfoList = specialize GXMLSerializationObjectList<TTovTorgTransferInfo>;
  TTovTorgTransferInfo_AdditionalInfosList = specialize GXMLSerializationObjectList<TTovTorgTransferInfo_AdditionalInfos>;
  ...
  TTovTorgSellerTitleInfo = class(TXmlSerializationObject)
  private
    ...
    FSigners:TTovTorgSellerTitleInfo_Signers;
    FGrounds:TTovTorgSellerTitleInfo_Grounds;
  ...
  published
    ...
    property Shipper:TExtendedOrganizationInfo read FShipper;
    property Consignee:TExtendedOrganizationInfo read FConsignee;
    property Carrier:TExtendedOrganizationInfo read FCarrier;
    property Signers:TTovTorgSellerTitleInfo_Signers read FSigners;
    property Grounds:TTovTorgSellerTitleInfo_Grounds read FGrounds;
    property TransferInfo:TTovTorgTransferInfo read FTransferInfo;
    property Table:TTovTorgTable read FTable;
  ...
  {  TTovTorgSellerTitle  }
  TTovTorgSellerTitle = class(TTovTorgSellerTitleInfo)
  private
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  ...
  {  TTovTorgSellerTitleInfo_Signers  }
  TTovTorgSellerTitleInfo_Signers = class(TXmlSerializationObject)
  private
  ...
  {  TTovTorgSellerTitleInfo_Grounds  }
  TTovTorgSellerTitleInfo_Grounds = class(TXmlSerializationObject)
  private
  ...
  {  TTovTorgTable  }
  TTovTorgTable = class(TXmlSerializationObject)
  private
    FItem:TTovTorgItemList;
    FTotalQuantity:Tinteger12;
    FTotalGross:Double;
    FTotalNet:Double;
    FTotalWithVatExcluded:Double;
    FTotalVat:Double;
    FTotal:Double;
    procedure SetTotalQuantity( AValue:Tinteger12);
    procedure SetTotalGross( AValue:Double);
  ...
  published
    ...
    property Item:TTovTorgItemList read FItem;
    //Количество мест всего по документу // КолМестВс
    property TotalQuantity:Tinteger12 read FTotalQuantity write SetTotalQuantity;
    //Масса брутто всего по документу // БруттоВс
    property TotalGross:Double read FTotalGross write SetTotalGross;
    //Масса нетто всего по документу // НеттоВс
    property TotalNet:Double read FTotalNet write SetTotalNet;
    //Сумма без учета налога // СтБезНДСВс
  ...
  {  TTovTorgItem  }
  TTovTorgItem = class(TXmlSerializationObject)
  private
    FAdditionalInfo:TAdditionalInfoList;
    FProduct:Tstring1000;
    FFeature:Tstring1000;
    FSort:Tstring10;
    FVendorCode:Tstring50;
    FProductCode:Tstring100;
    FUnitName:Tstring1000;
    FUnit1:Tokei;
    FPackageType:Tstring1000;
    FQuantityInPack:Double;
    FQuantity:Longint;
    FGross:Double;
    FNet:Double;
    ...
    procedure SetVendorCode( AValue:Tstring50);
    procedure SetProductCode( AValue:Tstring100);
    procedure SetUnitName( AValue:Tstring1000);
    procedure SetUnit1( AValue:Tokei);
    procedure SetPackageType( AValue:Tstring1000);
    procedure SetQuantityInPack( AValue:Double);
    procedure SetQuantity( AValue:Longint);
    procedure SetGross( AValue:Double);
    procedure SetNet( AValue:Double);
  ...
  published
    ...
    //артикул товара // АртикулТов
    property VendorCode:Tstring50 read FVendorCode write SetVendorCode;
    //Код товара // КодТов
    property ProductCode:Tstring100 read FProductCode write SetProductCode;
    ...
    property PackageType:Tstring1000 read FPackageType write SetPackageType;
    //количество мест в 1 упаковке // Место;
    property QuantityInPack:Double read FQuantityInPack write SetQuantityInPack;
    //количество единиц товара // КолМест;
    property Quantity:Longint read FQuantity write SetQuantity;
    //масса брутто // Брутто
    property Gross:Double read FGross write SetGross;
  ...
  TTovTorgTransferInfo = class(TXmlSerializationObject)
  private
    FWaybills:TWaybills;
    FEmployee:TEmployee;
    FOtherIssuer:TOtherIssuer;
    FAdditionalInfos:TTovTorgTransferInfo_AdditionalInfos;
    FOperationInfo:Tstring255;
    FTransferDate:Tdate1;
    FAttachment:Tstring255;
    procedure SetOperationInfo( AValue:Tstring255);
    procedure SetTransferDate( AValue:Tdate1);
    procedure SetAttachment( AValue:Tstring255);
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  public
  ...
  published
    ...
    property AdditionalInfos:TTovTorgTransferInfo_AdditionalInfos read FAdditionalInfos;
    ...
    property Attachment:Tstring255 read FAttachment write SetAttachment;
  end;

  {  TTovTorgTransferInfo_AdditionalInfos  }
  TTovTorgTransferInfo_AdditionalInfos = class(TXmlSerializationObject)
  private
    FAdditionalInfo:TAdditionalInfoList;
  protected
    procedure InternalRegisterPropertys; override;
...
implementation
  ...
  {  TTovTorgSellerTitleInfo  }
procedure TTovTorgSellerTitleInfo.SetCurrency(AValue: Tokv);
begin
  FCurrency:=AValue;
...
procedure TTovTorgSellerTitleInfo.SetCurrencyRate(AValue: Double);
begin
  FCurrencyRate:=AValue;
  ModifiedProperty('CurrencyRate');
end;

procedure TTovTorgSellerTitleInfo.SetDocumentDate(AValue: Tdate1);
begin
...
procedure TTovTorgSellerTitleInfo.SetDocumentNumber(AValue: Tstring255);
begin
...
procedure TTovTorgSellerTitleInfo.SetRevisionDate(AValue: Tdate1);
begin
...
procedure TTovTorgSellerTitleInfo.SetRevisionNumber(AValue: TCommonRevisionNumber);
begin
  FRevisionNumber:=AValue;
  ModifiedProperty('RevisionNumber');
end;

procedure TTovTorgSellerTitleInfo.SetDocumentCreator(AValue: Tstring1000);
begin
...
procedure TTovTorgSellerTitleInfo.SetDocumentCreatorBase(AValue: Tstring120);
begin
...
procedure TTovTorgSellerTitleInfo.SetOperationType(AValue: Tstring255);
begin
...
procedure TTovTorgSellerTitleInfo.SetGovernmentContractInfo(AValue: Tstring255);
begin
...
procedure TTovTorgSellerTitleInfo.SetDocumentName(AValue: Tstring255);
begin
...
procedure TTovTorgSellerTitleInfo.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
...
procedure TTovTorgSellerTitleInfo.InternalInitChilds;
begin
  ...
  FSigners:=TTovTorgSellerTitleInfo_Signers.Create;
  FGrounds:=TTovTorgSellerTitleInfo_Grounds.Create;
...
begin
  ...
  {  TTovTorgSellerTitle  }
procedure TTovTorgSellerTitle.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TTovTorgSellerTitle.InternalInitChilds;
begin
  inherited InternalInitChilds;
end;

destructor TTovTorgSellerTitle.Destroy;
begin
  inherited Destroy;
end;

function TTovTorgSellerTitle.RootNodeName:string;
begin
  Result:='TovTorgSellerTitle';
end;

  {  TTovTorgSellerTitleInfo_Signers  }
procedure TTovTorgSellerTitleInfo_Signers.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TTovTorgSellerTitleInfo_Signers.InternalInitChilds;
begin
  inherited InternalInitChilds;
...
destructor TTovTorgSellerTitleInfo_Signers.Destroy;
begin
  ...
  {  TTovTorgSellerTitleInfo_Grounds  }
procedure TTovTorgSellerTitleInfo_Grounds.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TTovTorgSellerTitleInfo_Grounds.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FGround:=TGroundInfoList.Create;
end;

destructor TTovTorgSellerTitleInfo_Grounds.Destroy;
begin
  FGround.Free;
  inherited Destroy;
end;
  ...
  {  TTovTorgTable  }
procedure TTovTorgTable.SetTotalQuantity(AValue: Tinteger12);
begin
  FTotalQuantity:=AValue;
  ModifiedProperty('TotalQuantity');
end;

procedure TTovTorgTable.SetTotalGross(AValue: Double);
begin
  FTotalGross:=AValue;
  ModifiedProperty('TotalGross');
end;

procedure TTovTorgTable.SetTotalNet(AValue: Double);
begin
  FTotalNet:=AValue;
  ModifiedProperty('TotalNet');
end;

procedure TTovTorgTable.SetTotalWithVatExcluded(AValue: Double);
begin
  FTotalWithVatExcluded:=AValue;
  ModifiedProperty('TotalWithVatExcluded');
end;

procedure TTovTorgTable.SetTotalVat(AValue: Double);
begin
  FTotalVat:=AValue;
  ModifiedProperty('TotalVat');
end;

procedure TTovTorgTable.SetTotal(AValue: Double);
begin
  FTotal:=AValue;
  ModifiedProperty('Total');
end;

procedure TTovTorgTable.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  P:=RegisterProperty('Item', 'Item', [], '', -1, -1);
  P:=RegisterProperty('TotalQuantity', 'TotalQuantity', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 0;
  P:=RegisterProperty('TotalGross', 'TotalGross', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 3;
...
procedure TTovTorgTable.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FItem:=TTovTorgItemList.Create;
end;
...
begin
  ...
  {  TTovTorgItem  }
procedure TTovTorgItem.SetProduct(AValue: Tstring1000);
begin
  FProduct:=AValue;
...
procedure TTovTorgItem.SetFeature(AValue: Tstring1000);
begin
  FFeature:=AValue;
...
procedure TTovTorgItem.SetSort(AValue: Tstring10);
begin
  FSort:=AValue;
...
procedure TTovTorgItem.SetVendorCode(AValue: Tstring50);
begin
  FVendorCode:=AValue;
  CheckStrMinSize('VendorCode', AValue);
  CheckStrMaxSize('VendorCode', AValue);
  ModifiedProperty('VendorCode');
end;

procedure TTovTorgItem.SetProductCode(AValue: Tstring100);
begin
  FProductCode:=AValue;
  CheckStrMinSize('ProductCode', AValue);
  CheckStrMaxSize('ProductCode', AValue);
  ModifiedProperty('ProductCode');
end;

procedure TTovTorgItem.SetUnitName(AValue: Tstring1000);
begin
  FUnitName:=AValue;
...
procedure TTovTorgItem.SetUnit1(AValue: Tokei);
begin
  FUnit1:=AValue;
...
procedure TTovTorgItem.SetPackageType(AValue: Tstring1000);
begin
  FPackageType:=AValue;
  CheckStrMinSize('PackageType', AValue);
  CheckStrMaxSize('PackageType', AValue);
  ModifiedProperty('PackageType');
end;

procedure TTovTorgItem.SetQuantityInPack(AValue: Double);
begin
  FQuantityInPack:=AValue;
  ModifiedProperty('QuantityInPack');
end;

procedure TTovTorgItem.SetQuantity(AValue: Longint);
begin
  FQuantity:=AValue;
  ModifiedProperty('Quantity');
end;

procedure TTovTorgItem.SetGross(AValue: Double);
begin
  FGross:=AValue;
  ModifiedProperty('Gross');
end;

procedure TTovTorgItem.SetNet(AValue: Double);
begin
  FNet:=AValue;
  ModifiedProperty('Net');
end;

procedure TTovTorgItem.SetItemToRelease(AValue: Double);
begin
  FItemToRelease:=AValue;
  ModifiedProperty('ItemToRelease');
end;

procedure TTovTorgItem.SetPrice(AValue: Double);
begin
  FPrice:=AValue;
  ModifiedProperty('Price');
end;

procedure TTovTorgItem.SetSubtotalWithVatExcluded(AValue: Double);
begin
  FSubtotalWithVatExcluded:=AValue;
  ModifiedProperty('SubtotalWithVatExcluded');
end;

procedure TTovTorgItem.SetTaxRate(AValue: TTaxRateWithTwentyPercentAndTaxedByAgent);
begin
  FTaxRate:=AValue;
...
procedure TTovTorgItem.SetVat(AValue: Double);
begin
  FVat:=AValue;
  ModifiedProperty('Vat');
end;

procedure TTovTorgItem.SetSubtotal(AValue: Double);
begin
  FSubtotal:=AValue;
  ModifiedProperty('Subtotal');
end;

procedure TTovTorgItem.SetItemAccountDebit(AValue: String);
begin
...
procedure TTovTorgItem.SetItemAccountCredit(AValue: String);
begin
...
procedure TTovTorgItem.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  ...
  P:=RegisterProperty('VendorCode', 'VendorCode', [], '', 1, 50);
  P:=RegisterProperty('ProductCode', 'ProductCode', [], '', 1, 100);
  P:=RegisterProperty('UnitName', 'UnitName', [], '', 1, 1000);
  P:=RegisterProperty('Unit1', 'Unit', [xsaRequared], '', 3, 4);
  P:=RegisterProperty('PackageType', 'PackageType', [], '', 1, 1000);
  P:=RegisterProperty('QuantityInPack', 'QuantityInPack', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 3;
  P:=RegisterProperty('Quantity', 'Quantity', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 0;
  P:=RegisterProperty('Gross', 'Gross', [], '', -1, -1);
    P.TotalDigits := 12;
    P.FractionDigits := 3;
  P:=RegisterProperty('Net', 'Net', [xsaRequared], '', -1, -1);
    P.TotalDigits := 26;
    P.FractionDigits := 11;
...
procedure TTovTorgItem.InternalInitChilds;
begin
  inherited InternalInitChilds;
...
begin
  ...
  {  TTovTorgTransferInfo  }
procedure TTovTorgTransferInfo.SetOperationInfo(AValue: Tstring255);
begin
...
procedure TTovTorgTransferInfo.SetTransferDate(AValue: Tdate1);
begin
...
procedure TTovTorgTransferInfo.SetAttachment(AValue: Tstring255);
begin
  FAttachment:=AValue;
  CheckStrMinSize('Attachment', AValue);
  CheckStrMaxSize('Attachment', AValue);
  ModifiedProperty('Attachment');
end;

procedure TTovTorgTransferInfo.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
  ...
  P:=RegisterProperty('Attachment', 'Attachment', [], '', 1, 255);
end;

procedure TTovTorgTransferInfo.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FWaybills:=TWaybills.Create;
  FEmployee:=TEmployee.Create;
  FOtherIssuer:=TOtherIssuer.Create;
  FAdditionalInfos:=TTovTorgTransferInfo_AdditionalInfos.Create;
end;
...
begin
  ...
  {  TTovTorgTransferInfo_AdditionalInfos  }
procedure TTovTorgTransferInfo_AdditionalInfos.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TTovTorgTransferInfo_AdditionalInfos.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FAdditionalInfo:=TAdditionalInfoList.Create;
end;

destructor TTovTorgTransferInfo_AdditionalInfos.Destroy;
begin
  FAdditionalInfo.Free;
  inherited Destroy;
end;
