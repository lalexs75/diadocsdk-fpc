...
unit XmlAcceptanceCertificate_DEFAULT_act_05_01_02_ind0;
...
type
  ...
  TAcceptanceCertificateSellerTitle = class;
  TAcceptanceCertificateSellerTitle_Works = class;
  TAcceptanceCertificateSellerTitle_Works_Work = class;
  TAcceptanceCertificateSellerTitle_Works_Work_Item = class;
  ...
  TAcceptanceCertificateSellerTitleList = specialize GXMLSerializationObjectList<TAcceptanceCertificateSellerTitle>;
  TAcceptanceCertificateSellerTitle_WorksList = specialize GXMLSerializationObjectList<TAcceptanceCertificateSellerTitle_Works>;
  TAcceptanceCertificateSellerTitle_Works_WorkList = specialize GXMLSerializationObjectList<TAcceptanceCertificateSellerTitle_Works_Work>;
  TAcceptanceCertificateSellerTitle_Works_Work_ItemList = specialize GXMLSerializationObjectList<TAcceptanceCertificateSellerTitle_Works_Work_Item>;
  ...
  published
    ...
    property Works:TAcceptanceCertificateSellerTitle_Works read FWorks;
    //сведения о подписи акта
    property Signature:TAcceptanceCertificateSignatureInfo read FSignature;
    //подписант
    ...
    //заголовок документа
    property DocumentTitle:Tstring2000 read FDocumentTitle write SetDocumentTitle;
    //дополнительная информация
    property AdditionalInfo:Tstring2000 read FAdditionalInfo write SetAdditionalInfo;
  end;

  {  TAcceptanceCertificateSellerTitle_Works  }
  TAcceptanceCertificateSellerTitle_Works = class(TXmlSerializationObject)
  private
    FWork:TAcceptanceCertificateSellerTitle_Works_WorkList;
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  public
    destructor Destroy; override;
  published
    property Work:TAcceptanceCertificateSellerTitle_Works_WorkList read FWork;
  end;

  {  TAcceptanceCertificateSellerTitle_Works_Work  }
  TAcceptanceCertificateSellerTitle_Works_Work = class(TXmlSerializationObject)
  private
    FItem:TAcceptanceCertificateSellerTitle_Works_Work_ItemList;
  ...
  public
    destructor Destroy; override;
  published
    property Item:TAcceptanceCertificateSellerTitle_Works_Work_ItemList read FItem;
  ...
  {  TAcceptanceCertificateSellerTitle_Works_Work_Item  }
  TAcceptanceCertificateSellerTitle_Works_Work_Item = class(TXmlSerializationObject)
  private
    FName:Tstring1000;
    FDescription:String;
    FUnitCode:Tokei;
...
implementation
  ...
  {  TAcceptanceCertificateSellerTitle  }
procedure TAcceptanceCertificateSellerTitle.SetDocumentDate(AValue: Tdate1);
begin
...
procedure TAcceptanceCertificateSellerTitle.SetDocumentNumber(AValue: Tstring256);
begin
...
procedure TAcceptanceCertificateSellerTitle.SetDocumentTitle(AValue: Tstring2000);
begin
  FDocumentTitle:=AValue;
  CheckStrMinSize('DocumentTitle', AValue);
  CheckStrMaxSize('DocumentTitle', AValue);
  ModifiedProperty('DocumentTitle');
end;

procedure TAcceptanceCertificateSellerTitle.SetAdditionalInfo(AValue: Tstring2000);
begin
...
procedure TAcceptanceCertificateSellerTitle.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  ...
  P:=RegisterProperty('Signature', 'Signature', [], '', -1, -1);
  ...
  P:=RegisterProperty('DocumentTitle', 'DocumentTitle', [xsaRequared], '', 1, 2000);
  P:=RegisterProperty('AdditionalInfo', 'AdditionalInfo', [], '', 1, 2000);
end;

procedure TAcceptanceCertificateSellerTitle.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FSeller:=TOrganizationInfo.Create;
  FBuyer:=TDocflowParticipant.Create;
  FWorks:=TAcceptanceCertificateSellerTitle_Works.Create;
  FSignature:=TAcceptanceCertificateSignatureInfo.Create;
  FSigner:=TSignerInfo.Create;
end;

destructor TAcceptanceCertificateSellerTitle.Destroy;
begin
  FSeller.Free;
  FBuyer.Free;
  FWorks.Free;
...
function TAcceptanceCertificateSellerTitle.RootNodeName:string;
begin
  Result:='AcceptanceCertificateSellerTitle';
end;

  {  TAcceptanceCertificateSellerTitle_Works  }
procedure TAcceptanceCertificateSellerTitle_Works.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TAcceptanceCertificateSellerTitle_Works.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FWork:=TAcceptanceCertificateSellerTitle_Works_WorkList.Create;
end;

destructor TAcceptanceCertificateSellerTitle_Works.Destroy;
begin
  FWork.Free;
  inherited Destroy;
end;
  ...
  {  TAcceptanceCertificateSellerTitle_Works_Work  }
procedure TAcceptanceCertificateSellerTitle_Works_Work.SetStartingDate(AValue: Tdate1);
begin
...
procedure TAcceptanceCertificateSellerTitle_Works_Work.SetCompletionDate(AValue: Tdate1);
begin
...
procedure TAcceptanceCertificateSellerTitle_Works_Work.SetTotalWithVatExcluded(AValue: Double);
begin
  FTotalWithVatExcluded:=AValue;
  ModifiedProperty('TotalWithVatExcluded');
end;

procedure TAcceptanceCertificateSellerTitle_Works_Work.SetVat(AValue: Double);
begin
  FVat:=AValue;
  ModifiedProperty('Vat');
end;

procedure TAcceptanceCertificateSellerTitle_Works_Work.SetTotal(AValue: Double);
begin
  FTotal:=AValue;
  ModifiedProperty('Total');
end;

procedure TAcceptanceCertificateSellerTitle_Works_Work.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TAcceptanceCertificateSellerTitle_Works_Work.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FItem:=TAcceptanceCertificateSellerTitle_Works_Work_ItemList.Create;
end;

destructor TAcceptanceCertificateSellerTitle_Works_Work.Destroy;
begin
  FItem.Free;
  inherited Destroy;
end;
  ...
  {  TAcceptanceCertificateSellerTitle_Works_Work_Item  }
procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetName(AValue: Tstring1000);
begin
  FName:=AValue;
...
procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetDescription(AValue: String);
begin
  FDescription:=AValue;
...
procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetUnitCode(AValue: Tokei);
begin
  FUnitCode:=AValue;
...
procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetUnitName(AValue: Tstring1000);
begin
  FUnitName:=AValue;
...
procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetPrice(AValue: Double);
begin
  FPrice:=AValue;
  ModifiedProperty('Price');
end;

procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetQuantity(AValue: Double);
begin
  FQuantity:=AValue;
  ModifiedProperty('Quantity');
end;

procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetSubtotalWithVatExcluded(AValue: Double);
begin
  FSubtotalWithVatExcluded:=AValue;
  ModifiedProperty('SubtotalWithVatExcluded');
end;

procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetVat(AValue: Double);
begin
  FVat:=AValue;
  ModifiedProperty('Vat');
end;

procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetSubtotal(AValue: Double);
begin
  FSubtotal:=AValue;
  ModifiedProperty('Subtotal');
end;

procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.SetAdditionalInfo(AValue: Tstring2000);
begin
  FAdditionalInfo:=AValue;
  CheckStrMinSize('AdditionalInfo', AValue);
  CheckStrMaxSize('AdditionalInfo', AValue);
...
procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TAcceptanceCertificateSellerTitle_Works_Work_Item.InternalInitChilds;
begin
  inherited InternalInitChilds;
end;

destructor TAcceptanceCertificateSellerTitle_Works_Work_Item.Destroy;
begin
  inherited Destroy;
end;
