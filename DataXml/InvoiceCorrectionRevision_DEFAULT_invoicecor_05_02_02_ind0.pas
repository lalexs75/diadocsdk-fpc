...
unit InvoiceCorrectionRevision_DEFAULT_invoicecor_05_02_02_ind0;
...
type
  ...
  TInvoiceCorrection = class;
  TInvoiceCorrection_Items = class;
  TInvoiceCorrection_AdditionalInfos = class;
  TInvoiceCorrectionItem = class;
  TInvoiceCorrectionItem_AdditionalInfos = class;
  ...
  TInvoiceCorrectionList = specialize GXMLSerializationObjectList<TInvoiceCorrection>;
  TInvoiceCorrection_ItemsList = specialize GXMLSerializationObjectList<TInvoiceCorrection_Items>;
  TInvoiceCorrection_AdditionalInfosList = specialize GXMLSerializationObjectList<TInvoiceCorrection_AdditionalInfos>;
  TInvoiceCorrectionItemList = specialize GXMLSerializationObjectList<TInvoiceCorrectionItem>;
  TInvoiceCorrectionItem_AdditionalInfosList = specialize GXMLSerializationObjectList<TInvoiceCorrectionItem_AdditionalInfos>;
  ...
  {  TInvoiceCorrection  }
  TInvoiceCorrection = class(TXmlSerializationObject)
  private
    FSeller:TOrganizationInfo;
    FBuyer:TOrganizationInfo;
    FSigner:TSignerInfo;
    FItems:TInvoiceCorrection_Items;
    FTotalsInc:TInvoiceTotalsDiff;
    FTotalsDec:TInvoiceTotalsDiff;
    FAdditionalInfos:TInvoiceCorrection_AdditionalInfos;
    FInvoiceDate:Tdate1;
    FInvoiceNumber:Tstring1000;
    FInvoiceRevisionDate:Tdate1;
    FInvoiceRevisionNumber:Longint;
    FInvoiceCorrectionDate:Tdate1;
    FInvoiceCorrectionNumber:Tstring1000;
    FInvoiceCorrectionRevisionDate:Tdate1;
    FInvoiceCorrectionRevisionNumber:Longint;
    FCurrency:Tokv;
    procedure SetInvoiceDate( AValue:Tdate1);
    procedure SetInvoiceNumber( AValue:Tstring1000);
    procedure SetInvoiceRevisionDate( AValue:Tdate1);
    procedure SetInvoiceRevisionNumber( AValue:Longint);
    procedure SetInvoiceCorrectionDate( AValue:Tdate1);
    procedure SetInvoiceCorrectionNumber( AValue:Tstring1000);
    procedure SetInvoiceCorrectionRevisionDate( AValue:Tdate1);
    procedure SetInvoiceCorrectionRevisionNumber( AValue:Longint);
  ...
  published
    ...
    property Items:TInvoiceCorrection_Items read FItems;
    property TotalsInc:TInvoiceTotalsDiff read FTotalsInc;
    property TotalsDec:TInvoiceTotalsDiff read FTotalsDec;
    property AdditionalInfos:TInvoiceCorrection_AdditionalInfos read FAdditionalInfos;
    property InvoiceDate:Tdate1 read FInvoiceDate write SetInvoiceDate;
    property InvoiceNumber:Tstring1000 read FInvoiceNumber write SetInvoiceNumber;
    property InvoiceRevisionDate:Tdate1 read FInvoiceRevisionDate write SetInvoiceRevisionDate;
    property InvoiceRevisionNumber:Longint read FInvoiceRevisionNumber write SetInvoiceRevisionNumber;
    property InvoiceCorrectionDate:Tdate1 read FInvoiceCorrectionDate write SetInvoiceCorrectionDate;
    property InvoiceCorrectionNumber:Tstring1000 read FInvoiceCorrectionNumber write SetInvoiceCorrectionNumber;
    property InvoiceCorrectionRevisionDate:Tdate1 read FInvoiceCorrectionRevisionDate write SetInvoiceCorrectionRevisionDate;
    property InvoiceCorrectionRevisionNumber:Longint read FInvoiceCorrectionRevisionNumber write SetInvoiceCorrectionRevisionNumber;
    property Currency:Tokv read FCurrency write SetCurrency;
  end;

  {  TInvoiceCorrection_Items  }
  TInvoiceCorrection_Items = class(TXmlSerializationObject)
  private
    FItem:TInvoiceCorrectionItemList;
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  public
    destructor Destroy; override;
  published
    property Item:TInvoiceCorrectionItemList read FItem;
  end;

  {  TInvoiceCorrection_AdditionalInfos  }
  TInvoiceCorrection_AdditionalInfos = class(TXmlSerializationObject)
  private
  ...
  TInvoiceCorrectionItem = class(TXmlSerializationObject)
  private
    FOriginalValues:TCorrectableInvoiceItemFields_WithTwentyPercent;
    FCorrectedValues:TCorrectableInvoiceItemFields_WithTwentyPercent;
    FAmountsInc:TInvoiceItemAmountsDiff;
    FAmountsDec:TInvoiceItemAmountsDiff;
    FAdditionalInfos:TInvoiceCorrectionItem_AdditionalInfos;
  ...
  public
    destructor Destroy; override;
  published
    property OriginalValues:TCorrectableInvoiceItemFields_WithTwentyPercent read FOriginalValues;
    property CorrectedValues:TCorrectableInvoiceItemFields_WithTwentyPercent read FCorrectedValues;
    property AmountsInc:TInvoiceItemAmountsDiff read FAmountsInc;
    property AmountsDec:TInvoiceItemAmountsDiff read FAmountsDec;
    property AdditionalInfos:TInvoiceCorrectionItem_AdditionalInfos read FAdditionalInfos;
    property Product:Tstring1000 read FProduct write SetProduct;
  end;

  {  TInvoiceCorrectionItem_AdditionalInfos  }
  TInvoiceCorrectionItem_AdditionalInfos = class(TXmlSerializationObject)
  private
    FAdditionalInfo:TAdditionalInfoList;
  protected
    procedure InternalRegisterPropertys; override;
...
implementation
  ...
  {  TInvoiceCorrection  }
procedure TInvoiceCorrection.SetInvoiceDate(AValue: Tdate1);
begin
  FInvoiceDate:=AValue;
...
procedure TInvoiceCorrection.SetInvoiceNumber(AValue: Tstring1000);
begin
...
procedure TInvoiceCorrection.SetInvoiceRevisionDate(AValue: Tdate1);
begin
...
procedure TInvoiceCorrection.SetInvoiceRevisionNumber(AValue: Longint);
begin
  FInvoiceRevisionNumber:=AValue;
  ModifiedProperty('InvoiceRevisionNumber');
end;

procedure TInvoiceCorrection.SetInvoiceCorrectionDate(AValue: Tdate1);
begin
  FInvoiceCorrectionDate:=AValue;
  CheckStrMinSize('InvoiceCorrectionDate', AValue);
  CheckStrMaxSize('InvoiceCorrectionDate', AValue);
  ModifiedProperty('InvoiceCorrectionDate');
end;

procedure TInvoiceCorrection.SetInvoiceCorrectionNumber(AValue: Tstring1000);
begin
  FInvoiceCorrectionNumber:=AValue;
  CheckStrMinSize('InvoiceCorrectionNumber', AValue);
  CheckStrMaxSize('InvoiceCorrectionNumber', AValue);
  ModifiedProperty('InvoiceCorrectionNumber');
end;

procedure TInvoiceCorrection.SetInvoiceCorrectionRevisionDate(AValue: Tdate1);
begin
  FInvoiceCorrectionRevisionDate:=AValue;
  CheckStrMinSize('InvoiceCorrectionRevisionDate', AValue);
  CheckStrMaxSize('InvoiceCorrectionRevisionDate', AValue);
  ModifiedProperty('InvoiceCorrectionRevisionDate');
end;

procedure TInvoiceCorrection.SetInvoiceCorrectionRevisionNumber(AValue: Longint);
begin
  FInvoiceCorrectionRevisionNumber:=AValue;
  ModifiedProperty('InvoiceCorrectionRevisionNumber');
end;

procedure TInvoiceCorrection.SetCurrency(AValue: Tokv);
begin
  FCurrency:=AValue;
...
procedure TInvoiceCorrection.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  ...
  P:=RegisterProperty('InvoiceNumber', 'InvoiceNumber', [xsaRequared], '', 1, 1000);
  P:=RegisterProperty('InvoiceRevisionDate', 'InvoiceRevisionDate', [], '', 10, 10);
  P:=RegisterProperty('InvoiceRevisionNumber', 'InvoiceRevisionNumber', [], '', -1, -1);
    P.TotalDigits := 3;
    P.FractionDigits := 0;
  P:=RegisterProperty('InvoiceCorrectionDate', 'InvoiceCorrectionDate', [xsaRequared], '', 10, 10);
  P:=RegisterProperty('InvoiceCorrectionNumber', 'InvoiceCorrectionNumber', [xsaRequared], '', 1, 1000);
  P:=RegisterProperty('InvoiceCorrectionRevisionDate', 'InvoiceCorrectionRevisionDate', [], '', 10, 10);
  P:=RegisterProperty('InvoiceCorrectionRevisionNumber', 'InvoiceCorrectionRevisionNumber', [], '', -1, -1);
    P.TotalDigits := 3;
    P.FractionDigits := 0;
  P:=RegisterProperty('Currency', 'Currency', [], '', 3, 3);
end;

procedure TInvoiceCorrection.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FSeller:=TOrganizationInfo.Create;
  FBuyer:=TOrganizationInfo.Create;
  FSigner:=TSignerInfo.Create;
  FItems:=TInvoiceCorrection_Items.Create;
  FTotalsInc:=TInvoiceTotalsDiff.Create;
  FTotalsDec:=TInvoiceTotalsDiff.Create;
  FAdditionalInfos:=TInvoiceCorrection_AdditionalInfos.Create;
end;

destructor TInvoiceCorrection.Destroy;
begin
  FSeller.Free;
  FBuyer.Free;
  FSigner.Free;
...
function TInvoiceCorrection.RootNodeName:string;
begin
  Result:='InvoiceCorrection';
end;

  {  TInvoiceCorrection_Items  }
procedure TInvoiceCorrection_Items.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TInvoiceCorrection_Items.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FItem:=TInvoiceCorrectionItemList.Create;
end;

destructor TInvoiceCorrection_Items.Destroy;
begin
  FItem.Free;
  inherited Destroy;
end;
  ...
  {  TInvoiceCorrection_AdditionalInfos  }
procedure TInvoiceCorrection_AdditionalInfos.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TInvoiceCorrection_AdditionalInfos.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FAdditionalInfo:=TAdditionalInfoList.Create;
end;

destructor TInvoiceCorrection_AdditionalInfos.Destroy;
begin
  ...
  {  TInvoiceCorrectionItem  }
procedure TInvoiceCorrectionItem.SetProduct(AValue: Tstring1000);
begin
  FProduct:=AValue;
...
procedure TInvoiceCorrectionItem.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TInvoiceCorrectionItem.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FOriginalValues:=TCorrectableInvoiceItemFields_WithTwentyPercent.Create;
  FCorrectedValues:=TCorrectableInvoiceItemFields_WithTwentyPercent.Create;
  FAmountsInc:=TInvoiceItemAmountsDiff.Create;
  FAmountsDec:=TInvoiceItemAmountsDiff.Create;
  FAdditionalInfos:=TInvoiceCorrectionItem_AdditionalInfos.Create;
end;
...
begin
  ...
  {  TInvoiceCorrectionItem_AdditionalInfos  }
procedure TInvoiceCorrectionItem_AdditionalInfos.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TInvoiceCorrectionItem_AdditionalInfos.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FAdditionalInfo:=TAdditionalInfoList.Create;
end;

destructor TInvoiceCorrectionItem_AdditionalInfos.Destroy;
begin
  FAdditionalInfo.Free;
  inherited Destroy;
end;
