...
unit XmlAcceptanceCertificate_DEFAULT_rezru_05_01_01_ind1;
...
type
  ...
  TAcceptanceCertificate552BuyerTitleInfo = class;
  TAcceptanceCertificate552BuyerTitle = class;
  TAcceptanceCertificate552BuyerTitleInfo_Signers = class;
  ...
  TAcceptanceCertificate552BuyerTitleInfoList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552BuyerTitleInfo>;
  TAcceptanceCertificate552BuyerTitleList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552BuyerTitle>;
  TAcceptanceCertificate552BuyerTitleInfo_SignersList = specialize GXMLSerializationObjectList<TAcceptanceCertificate552BuyerTitleInfo_Signers>;
  ...
  TAcceptanceCertificate552BuyerTitleInfo = class(TXmlSerializationObject)
  private
    FSigners:TAcceptanceCertificate552BuyerTitleInfo_Signers;
    FAdditionalInfoId:TAdditionalInfoId;
    FDocumentCreator:Tstring1000;
    FDocumentCreatorBase:Tstring120;
    FOperationType:Tstring255;
    FOperationContent:Tstring1000;
    FAcceptanceDate:Tdate1;
    FCreatedThingAcceptDate:Tdate1;
    ...
    procedure SetOperationContent( AValue:Tstring1000);
    procedure SetAcceptanceDate( AValue:Tdate1);
    procedure SetCreatedThingAcceptDate( AValue:Tdate1);
  ...
  published
    property Signers:TAcceptanceCertificate552BuyerTitleInfo_Signers read FSigners;
    ...
    //Вид операции // ВидОперации/Файл/Документ/СодФХЖ3/ВидОперации
    property OperationType:Tstring255 read FOperationType write SetOperationType;
    //Содержание операции // СодОпер/Файл/Документ/СодФХЖ3/РезПринял/@СодОпер
    property OperationContent:Tstring1000 read FOperationContent write SetOperationContent;
    //Дата передачи результатов работ // ДатаПрием/Файл/Документ/СодФХЖ3/РезПринял/@ДатаПрием
    property AcceptanceDate:Tdate1 read FAcceptanceDate write SetAcceptanceDate;
    //Дата передачи вещи, изготовленной по договору подряда // ДатаПол/Файл/Документ/СодФХЖ3/СвПолВещи/@ДатаПол
    property CreatedThingAcceptDate:Tdate1 read FCreatedThingAcceptDate write SetCreatedThingAcceptDate;
    //Сведения о передаче // СвПол/Файл/Документ/СодФХЖ3/СвПолВещи/@СвПол
    property CreatedThingInfo:Tstring1000 read FCreatedThingInfo write SetCreatedThingInfo;
  end;

  {  TAcceptanceCertificate552BuyerTitle  }
  TAcceptanceCertificate552BuyerTitle = class(TAcceptanceCertificate552BuyerTitleInfo)
  private
  protected
    procedure InternalRegisterPropertys; override;
    procedure InternalInitChilds; override;
  ...
  {  TAcceptanceCertificate552BuyerTitleInfo_Signers  }
  TAcceptanceCertificate552BuyerTitleInfo_Signers = class(TXmlSerializationObject)
  private
...
implementation
  ...
  {  TAcceptanceCertificate552BuyerTitleInfo  }
procedure TAcceptanceCertificate552BuyerTitleInfo.SetDocumentCreator(AValue: Tstring1000);
begin
...
procedure TAcceptanceCertificate552BuyerTitleInfo.SetDocumentCreatorBase(AValue: Tstring120);
begin
...
procedure TAcceptanceCertificate552BuyerTitleInfo.SetOperationType(AValue: Tstring255);
begin
...
procedure TAcceptanceCertificate552BuyerTitleInfo.SetOperationContent(AValue: Tstring1000);
begin
...
procedure TAcceptanceCertificate552BuyerTitleInfo.SetAcceptanceDate(AValue: Tdate1);
begin
...
procedure TAcceptanceCertificate552BuyerTitleInfo.SetCreatedThingAcceptDate(AValue: Tdate1);
begin
  FCreatedThingAcceptDate:=AValue;
  CheckStrMinSize('CreatedThingAcceptDate', AValue);
  CheckStrMaxSize('CreatedThingAcceptDate', AValue);
  ModifiedProperty('CreatedThingAcceptDate');
end;

procedure TAcceptanceCertificate552BuyerTitleInfo.SetCreatedThingInfo(AValue: Tstring1000);
begin
...
procedure TAcceptanceCertificate552BuyerTitleInfo.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  ...
  P:=RegisterProperty('OperationContent', 'OperationContent', [xsaRequared], '', 1, 1000);
  P:=RegisterProperty('AcceptanceDate', 'AcceptanceDate', [], '', 10, 10);
  P:=RegisterProperty('CreatedThingAcceptDate', 'CreatedThingAcceptDate', [], '', 10, 10);
  P:=RegisterProperty('CreatedThingInfo', 'CreatedThingInfo', [], '', 1, 1000);
end;

procedure TAcceptanceCertificate552BuyerTitleInfo.InternalInitChilds;
begin
  inherited InternalInitChilds;
  FSigners:=TAcceptanceCertificate552BuyerTitleInfo_Signers.Create;
...
begin
  ...
  {  TAcceptanceCertificate552BuyerTitle  }
procedure TAcceptanceCertificate552BuyerTitle.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TAcceptanceCertificate552BuyerTitle.InternalInitChilds;
begin
  inherited InternalInitChilds;
end;

destructor TAcceptanceCertificate552BuyerTitle.Destroy;
begin
  inherited Destroy;
end;

function TAcceptanceCertificate552BuyerTitle.RootNodeName:string;
begin
  Result:='AcceptanceCertificate552BuyerTitle';
end;

  {  TAcceptanceCertificate552BuyerTitleInfo_Signers  }
procedure TAcceptanceCertificate552BuyerTitleInfo_Signers.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TAcceptanceCertificate552BuyerTitleInfo_Signers.InternalInitChilds;
begin
  inherited InternalInitChilds;
...
destructor TAcceptanceCertificate552BuyerTitleInfo_Signers.Destroy;
begin
