...
unit UniversalCorrectionDocumentRevision_KSCHFDIS_ucd_05_01_02_ind0;
...
type
  ...
  private
    FOriginalValues:TCorrectableInvoiceItemFields_WithTaxedByAgent;
    FCorrectedValues:TCorrectableInvoiceItemFields_WithTaxedByAgent;
  ...
  published
    ...
    property OriginalValues:TCorrectableInvoiceItemFields_WithTaxedByAgent read FOriginalValues;
    //значения после изменения
    property CorrectedValues:TCorrectableInvoiceItemFields_WithTaxedByAgent read FCorrectedValues;
    //суммы к увеличению
...
begin
  inherited InternalInitChilds;
  FOriginalValues:=TCorrectableInvoiceItemFields_WithTaxedByAgent.Create;
  FCorrectedValues:=TCorrectableInvoiceItemFields_WithTaxedByAgent.Create;
