...
unit InvoiceCorrectionRevision_DEFAULT_invoicecor_05_01_03_ind0;
...
type
  ...
  TCorrectableInvoiceItemFields_TaxRateWith20Percent = class;
  ...
  TCorrectableInvoiceItemFields_TaxRateWith20PercentList = specialize GXMLSerializationObjectList<TCorrectableInvoiceItemFields_TaxRateWith20Percent>;
  ...
  private
    ...
    FInvoiceCorrectionNumber:Tstring256;
    ...
    procedure SetInvoiceCorrectionNumber( AValue:Tstring256);
  ...
  published
    ...
    property InvoiceCorrectionNumber:Tstring256 read FInvoiceCorrectionNumber write SetInvoiceCorrectionNumber;
    property InvoiceCorrectionRevisionDate:Tdate1 read FInvoiceCorrectionRevisionDate write SetInvoiceCorrectionRevisionDate;
    property InvoiceCorrectionRevisionNumber:String read FInvoiceCorrectionRevisionNumber write SetInvoiceCorrectionRevisionNumber;
  ...
  private
    FOriginalValues:TCorrectableInvoiceItemFields_TaxRateWith20Percent;
    FCorrectedValues:TCorrectableInvoiceItemFields_TaxRateWith20Percent;
  ...
  public
    destructor Destroy; override;
  published
    property OriginalValues:TCorrectableInvoiceItemFields_TaxRateWith20Percent read FOriginalValues;
    property CorrectedValues:TCorrectableInvoiceItemFields_TaxRateWith20Percent read FCorrectedValues;
  ...
  {  TCorrectableInvoiceItemFields_TaxRateWith20Percent  }
  TCorrectableInvoiceItemFields_TaxRateWith20Percent = class(TCorrectableInvoiceItemFields_WithoutTaxRate)
  private
...
procedure TInvoiceCorrection.SetInvoiceNumber(AValue: Tstring256);
begin
...
procedure TInvoiceCorrection.SetInvoiceRevisionNumber(AValue: String);
begin
...
procedure TInvoiceCorrection.SetInvoiceCorrectionNumber(AValue: Tstring256);
begin
...
procedure TInvoiceCorrection.SetInvoiceCorrectionRevisionNumber(AValue: String);
begin
  FInvoiceCorrectionRevisionNumber:=AValue;
  CheckStrMinSize('InvoiceCorrectionRevisionNumber', AValue);
  CheckStrMaxSize('InvoiceCorrectionRevisionNumber', AValue);
...
procedure TInvoiceCorrection.SetAdditionalInfo(AValue: Tstring2000);
begin
...
begin
  ...
  P:=RegisterProperty('InvoiceCorrectionNumber', 'InvoiceCorrectionNumber', [xsaRequared], '', 1, 256);
  P:=RegisterProperty('InvoiceCorrectionRevisionDate', 'InvoiceCorrectionRevisionDate', [], '', 10, 10);
  P:=RegisterProperty('InvoiceCorrectionRevisionNumber', 'InvoiceCorrectionRevisionNumber', [], '', 1, 3);
...
procedure TInvoiceCorrectionItem.SetAdditionalInfo(AValue: Tstring2000);
begin
  FAdditionalInfo:=AValue;
  CheckStrMinSize('AdditionalInfo', AValue);
  CheckStrMaxSize('AdditionalInfo', AValue);
...
begin
  inherited InternalInitChilds;
  FOriginalValues:=TCorrectableInvoiceItemFields_TaxRateWith20Percent.Create;
  FCorrectedValues:=TCorrectableInvoiceItemFields_TaxRateWith20Percent.Create;
...
begin
  ...
  {  TCorrectableInvoiceItemFields_TaxRateWith20Percent  }
procedure TCorrectableInvoiceItemFields_TaxRateWith20Percent.SetTaxRate(AValue: TTaxRate_With20Percent);
begin
  FTaxRate:=AValue;
...
procedure TCorrectableInvoiceItemFields_TaxRateWith20Percent.InternalRegisterPropertys;
var
  P: TPropertyDef;
begin
  inherited InternalRegisterPropertys;
...
procedure TCorrectableInvoiceItemFields_TaxRateWith20Percent.InternalInitChilds;
begin
  inherited InternalInitChilds;
end;

destructor TCorrectableInvoiceItemFields_TaxRateWith20Percent.Destroy;
begin
  inherited Destroy;
end;
