...
unit DiadocTypes_SignatureRejectionInfo;
...
type
  ...
  //}
  TSignatureRejectionInfo = class(TSerializationObject)
  private
...
procedure TSignatureRejectionInfo.InternalInit;
begin
  inherited InternalInit;
  FSigner:=TSigner.Create;
end;

procedure TSignatureRejectionInfo.InternalRegisterProperty;
begin
...
destructor TSignatureRejectionInfo.Destroy;
begin
  FreeAndNil(FSigner);
  inherited Destroy;
end;
