...
unit AmendmentRequestResponseBehavior;
...
type
  ...
  //}
  TAmendmentRequestResponseBehavior = (
    Unknown = 0,
    None = 1,
    Receipt = 2,
    OperatorConfirmation = 3,
  ...
  TAmendmentRequestResponseBehaviorArray = array of TAmendmentRequestResponseBehavior;
