...
unit OperatorConfirmationReceiptBehavior;
...
type
  ...
  //    Always = 2;
  //}
  TOperatorConfirmationReceiptBehavior = (
    Unknown = 0,
    Never = 1,
    Always = 2
  );
  TOperatorConfirmationReceiptBehaviorArray = array of TOperatorConfirmationReceiptBehavior;
