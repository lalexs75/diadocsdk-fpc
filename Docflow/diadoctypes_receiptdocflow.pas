...
unit DiadocTypes_ReceiptDocflow;
...
*)
uses
  Classes, SysUtils, protobuf_fpc, DiadocTypes_Attachment;
...
type
  ...
  //}
  TReceiptDocflow = class(TSerializationObject) //message ReceiptDocflow
  private
    FIsFinished: Boolean;
...
procedure TReceiptDocflow.InternalInit;
begin
  inherited InternalInit;
  FReceiptAttachment:=TSignedAttachment.Create;
end;

destructor TReceiptDocflow.Destroy;
begin
